...
const EditProTableMeta: ComponentMetadata = {
  ...
  category: '表格类',
  npm: {
    package: 'zw-edit-protable',
    version: '0.1.0',
    exportName: 'EditProTable',
    main: 'src\\index.tsx',
    destructuring: true,
    subName: '',
  },
    ...
    props: [
      ...
      },
      {
        ...
        items: [
          {
            name: 'dataSource',
            title: { label: '表格数据', tip: 'dataSource | Table 的数据' },
            propType: 'func',
            setter: {
              componentName: 'FunctionSetter',
              isRequired: false,
          ...
          {
            name: 'value',
            title: { label: '表格数据', tip: 'value | 表格数据' },
            propType: 'object',
            setter: 'JsonSetter',
          },
          {
      ...
      },
      {
        ...
        items: [
          {
            name: 'getColumnsByFunc',
            title: { label: '获取表格列', tip: '使用function动态获取表格列，优先使用此处列数据' },
            propType: 'func',
            setter: {
              componentName: 'FunctionSetter',
              isRequired: false,
          ...
          },
          {
            ...
            propType: { type: 'oneOfType', value: ['array', 'func', 'variable'] },
            setter: [
              {
      ...
      },
      {
        ...
        items: [
          {
            name: 'editable.type',
            title: { label: '是否多行', tip: 'editable.type | 是否多行' },
            propType: 'bool',
            setter: 'BoolSetter',
            defaultValue: false,
          },
          {
            name: 'recordCreatorProps.position',
            title: { label: '新增按钮位置', tip: 'recordCreatorProps.position | 新增按钮的位置' },
            propType: {
              type: 'oneOf',
              value: ['bottom', 'top'],
            },
          ...
          {
            name: 'editable.saveText',
            title: {
              label: '保存文本',
              tip: 'editable.saveText | 保存一行的文字',
            },
            propType: 'string',
            setter: 'StringSetter',
          },
          {
            name: 'editable.cancelText',
            title: {
              label: '取消编辑文本',
              tip: 'editable.cancelText | 取消编辑一行的文字	',
            },
            propType: 'string',
            setter: 'StringSetter',
          },
          {
            name: 'editable.deletePopconfirmMessage',
            title: {
              label: '删除提示',
              tip: 'editable.deletePopconfirmMessage | 删除时弹出的确认框提示消息	',
            },
            propType: 'string',
            setter: 'StringSetter',
          },
          {
            name: 'editable.onlyOneLineEditorAlertMessage',
            title: {
              label: '编辑错误提示',
              tip: 'editable.onlyOneLineEditorAlertMessage | 只能编辑一行的的提示	',
            },
            propType: 'string',
            setter: 'StringSetter',
          },
          {
            name: 'editable.onlyAddOneLineAlertMessage',
            title: {
              label: '新增错误提示',
              tip: 'editable.onlyAddOneLineAlertMessage | 只能同时新增一行的提示	',
            },
            propType: 'string',
            setter: 'StringSetter',
          },
          {
            ...
            title: {
              label: 'onChange',
              tip: 'onChange | dataSource 修改时触发，删除和修改都会触发,如果设置了 value，Table 会成为一个受控组件。',
            },
            propType: 'func',
            setter: [
              {
          ...
          },
          {
            ...
            title: {
              label: 'editable.onChange',
              tip: 'editable.onChange | 行数据被修改的时候触发',
            },
            propType: 'func',
            setter: [
              {
                componentName: 'FunctionSetter',
                props: {
                  template: 'onRowChange(editableKeys, editableRows ,${extParams}){\n\n}',
                },
              },
            ],
          },
          {
            name: 'editable.onSave',
            title: {
              label: 'editable.onSave',
              tip: 'editable.onSave | 保存一行的时候触发',
            },
            propType: 'func',
            setter: [
              {
                componentName: 'FunctionSetter',
                props: {
                  template: 'onRowSave(key, row,originRow,newLine,${extParams}){\n\n}',
                },
              },
            ],
          },
          {
            name: 'editable.onDelete',
            title: {
              label: 'editable.onDelete',
              tip: 'editable.onDelete | 删除一行的时候触发',
            },
            propType: 'func',
            setter: [
              {
                componentName: 'FunctionSetter',
                props: {
                  template: 'onRowDelete(key, row,${extParams}){\n\n}',
                },
              },
            ],
          },
