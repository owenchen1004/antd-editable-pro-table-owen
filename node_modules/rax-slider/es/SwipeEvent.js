...
var SwipeEvent = /*#__PURE__*/function (_Component) {
    ...
    _this.panResponder = PanResponder.create({
      ...
      onPanResponderMove: function onPanResponderMove(evt, gestureState) {
        ...
        if (!_this.swipeDetected) {
          ...
          validHorizontal = horizontal ? isValidSwipe(vx, dy, initialVelocityThreshold, verticalThreshold) : false; // vertical
  ...
  _proto.render = function render() {
    ...
    return createElement(View, _extends({}, this.panResponder.panHandlers, {
      style: _extends({}, {
        alignSelf: 'flex-start'
      }, props.handlerStyle)
    }), createElement(View, _extends({}, props, state), this.props.children));
  };
