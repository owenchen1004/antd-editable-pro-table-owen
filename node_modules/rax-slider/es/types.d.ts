...
export interface SliderProps extends Rax.RefAttributes<HTMLElement>, Rax.HTMLAttributes<HTMLElement> {
    className?: string;
...
export interface SwipeEventProps extends Rax.RefAttributes<HTMLDivElement>, Rax.HTMLAttributes<HTMLDivElement> {
