...
function setStyles(node, styles) {
  if (_universalEnv.isWeb) {
    ...
    _rax.shared.Host.driver.setStyle(node, styles);
  }
}
...
function addEventListener(node, eventName, eventHandler, props) {
  if (_universalEnv.isWeb) {
    ...
    return _rax.shared.Host.driver.addEventListener(node, eventName, eventHandler, props);
  }
}
...
function setAttribute(node, propKey, propValue) {
  if (_universalEnv.isWeb) {
    ...
    _rax.shared.Host.driver.setAttribute(node, propKey, propValue);
  }
}
/**
