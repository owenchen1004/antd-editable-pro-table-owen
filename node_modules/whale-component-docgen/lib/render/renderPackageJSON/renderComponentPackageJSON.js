...
exports.renderComponentPackageJSON = void 0;
...
const renderComponentPackageJSON = (packageJSON, source) => [
    ...
    mdast_builder_1.heading(2, mdast_builder_1.text('安装方法')),
    mdast_builder_1.code('sh', `$ tnpm install ${packageJSON.name} --save`),
    packageJSON.componentConfig &&
        mdast_builder_1.paragraph(mdast_builder_1.link('https://yuque.antfin-inc.com/bp-xt-dt/battle/components_used_in_iceworks', '如何iceworks中使用组件', mdast_builder_1.text('如何iceworks中使用组件'))),
    mdast_builder_1.heading(2, mdast_builder_1.text('API')),
].filter((vo) => vo);
exports.renderComponentPackageJSON = renderComponentPackageJSON;
            ...
            renderBadges_1.gitlabBugIssueBadge(`${remoteUrl}/issues/new?${qs.stringify({
                issue: {
                    ...
                    description: [
                        '### 环境信息',
                        '',
                        `- 组件名称： ${materialConfig === null || materialConfig === void 0 ? void 0 : materialConfig.title}`,
            ...
            renderBadges_1.gitlabEnhancementIssueBadge(`${remoteUrl}/issues/new?${qs.stringify({
                issue: {
                    ...
                    description: [
                        '### 环境信息',
                        '',
                        `- 组件名称: ${materialConfig === null || materialConfig === void 0 ? void 0 : materialConfig.name} ${materialConfig === null || materialConfig === void 0 ? void 0 : materialConfig.title}`,
                        `- 组件版本: ${packageJSON.version}`,
                        '',
                        '<!-- 在此描述需求 -->',
                        '',
...
//# sourceMappingURL=renderComponentPackageJSON.js.map