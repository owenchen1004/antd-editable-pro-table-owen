import { WmComponentDoc } from 'whale-docgen-ts';
export declare const renderComponentDocs: (docs: WmComponentDoc[]) => import("unist").Node[];
/**
 ...
 * ```
 */
export declare const aliMaterialRenderer: (componentDoc: WmComponentDoc) => import("unist").Node[];
