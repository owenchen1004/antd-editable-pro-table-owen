...
exports.megreAssets = megreAssets;
...
function megreAssets(assets, incrementalAssets) {
...
function megreAssetsComponentList(assets, incrementalAssets, listName) {
...
var StylePoint = /*#__PURE__*/function () {
...
var AssetLoader = /*#__PURE__*/function () {
          ...
          case 8:
            ...
            return Promise.all(scriptQueue.map(function (_ref2) {
              var content = _ref2.content,
                type = _ref2.type;
              return _this.loadScript(content, type === _lowcodeTypes.AssetType.JSUrl);
            }));
          case 10:
          case "end":
  ...
  _proto2.loadScript = function loadScript(content, isUrl) {
    if (!content) {
      return;
    }
    return isUrl ? (0, _script.load)(content) : (0, _script.evaluate)(content);
  }
