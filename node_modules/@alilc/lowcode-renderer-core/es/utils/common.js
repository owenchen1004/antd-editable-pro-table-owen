 ...
 * @returns funtion
 */
export function parseExpression(str, self, thisRequired) {
  if (thisRequired === void 0) {
    thisRequired = false;
  }
  try {
    ...
    var _self$__self;
    logger.error('parseExpression.error', err, str, (_self$__self = self === null || self === void 0 ? void 0 : self.__self) !== null && _self$__self !== void 0 ? _self$__self : self);
    return undefined;
  }
}
