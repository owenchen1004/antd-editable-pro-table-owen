...
export default function rendererFactory() {
  ...
  var FaultComponent = /*#__PURE__*/function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      logger.error("%c\u7EC4\u4EF6\u6E32\u67D3\u5F02\u5E38, \u5F02\u5E38\u539F\u56E0: " + (((_this$props$error = this.props.error) === null || _this$props$error === void 0 ? void 0 : _this$props$error.message) || this.props.error || '未知'), 'color: #ff0000;');
