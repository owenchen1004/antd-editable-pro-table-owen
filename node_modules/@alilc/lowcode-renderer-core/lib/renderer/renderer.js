...
function rendererFactory() {
  ...
  var FaultComponent = /*#__PURE__*/function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      _logger["default"].error("%c\u7EC4\u4EF6\u6E32\u67D3\u5F02\u5E38, \u5F02\u5E38\u539F\u56E0: " + (((_this$props$error = this.props.error) === null || _this$props$error === void 0 ? void 0 : _this$props$error.message) || this.props.error || '未知'), 'color: #ff0000;');
  ...
  return _class = /*#__PURE__*/function (_Component) {
    ...
    _proto3.render = function render() {
      var _this$props4 = this.props,
        ...
        designMode = _this$props4.designMode,
        appHelper = _this$props4.appHelper,
