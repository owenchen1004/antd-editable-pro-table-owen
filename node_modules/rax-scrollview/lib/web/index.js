...
var ScrollView = (0, _rax.forwardRef)(function (props, ref) {
  ...
  var contentContainer = (0, _rax.createElement)(_raxView.default, {
    ...
    className: (0, _classnames.default)((_cx = {}, _cx[baseCls + "-content-container-horizontal"] = horizontal, _cx[baseCls + "-webcontainer"] = !horizontal, _cx)),
    style: Object.assign({}, _getStyle((0, _classnames.default)((_cx = {}, _cx[baseCls + "-content-container-horizontal"] = horizontal, _cx[baseCls + "-webcontainer"] = !horizontal, _cx))), contentContainerStyle)
  }, children);
