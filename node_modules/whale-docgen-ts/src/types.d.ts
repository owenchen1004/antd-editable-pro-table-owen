...
export declare type WmPropItemType = WmPlainPropItemType | WmUnionPropItemType | WmIntersectionPropItemType | WmObjectPropItemType | WmArrayPropItemType | WmFunctionPropItemType;
...
export declare type WmProps = Record<string, WmPropItem>;
