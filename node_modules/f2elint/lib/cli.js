...
commander_1.program
    ...
    .description(constants_1.PKG_NAME + " \u662F\u300A\u963F\u91CC\u5DF4\u5DF4\u524D\u7AEF\u89C4\u7EA6\u300B\u7684\u914D\u5957 Lint \u5DE5\u5177\uFF0C\u63D0\u4F9B\u7B80\u5355\u7684 CLI \u548C Node.js API\uFF0C\u8BA9\u9879\u76EE\u80FD\u591F\u4E00\u952E\u63A5\u5165\u3001\u4E00\u952E\u626B\u63CF\u3001\u4E00\u952E\u4FEE\u590D\u3001\u4E00\u952E\u5347\u7EA7\uFF0C\u5E76\u4E3A\u9879\u76EE\u914D\u7F6E git commit \u5361\u70B9\uFF0C\u964D\u4F4E\u9879\u76EE\u5B9E\u65BD\u89C4\u7EA6\u7684\u6210\u672C");
commander_1.program
    .command('init')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                configPath = path_1.default.resolve(cwd, constants_1.PKG_NAME + ".config.js");
...
commander_1.program
    ...
    .action(function () {
    var result = cross_spawn_1.default.sync(path_1.default.resolve(cwd, "./node_modules/" + constants_1.PKG_NAME + "/node_modules/.bin/commitlint"), ['-E', 'HUSKY_GIT_PARAMS'], { stdio: 'inherit' });
    if (result.status !== 0) {
