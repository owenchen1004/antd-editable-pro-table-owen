...
var checkLatestVersion = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                npm = _a.sent();
                latestVersion = (0, child_process_1.execSync)(npm + " view " + constants_1.PKG_NAME + " version").toString('utf-8').trim();
...
exports.default = (function (install) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    checking = (0, ora_1.default)("[" + constants_1.PKG_NAME + "] \u6B63\u5728\u68C0\u67E5\u6700\u65B0\u7248\u672C...");
                    checking.start();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                ...
                case 3:
                    ...
                    if (latestVersion && install) {
                        update = (0, ora_1.default)("[" + constants_1.PKG_NAME + "] \u5B58\u5728\u65B0\u7248\u672C\uFF0C\u5C06\u5347\u7EA7\u81F3 " + latestVersion);
                        update.start();
