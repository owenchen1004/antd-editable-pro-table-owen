...
exports.default = (function (results, fix) {
    ...
    var transformMessage = function (_a) {
        ...
        var text = '';
        if (rule && url) {
            text = terminal_link_1.default(chalk_1.default.blue(rule), chalk_1.default.dim(" " + url + " "), { fallback: !is_docker_1.default() });
        }
        else if (rule) {
    ...
    try {
        for (var results_1 = __values(results), results_1_1 = results_1.next(); !results_1_1.done; results_1_1 = results_1.next()) {
            ...
            output += text_table_1.default(messages.map(transformMessage), {
                align: ['.', 'r', 'l'],
    ...
    var pluralize = function (word, count) { return (count === 1 ? word : word + "s"); };
    if (fix)
