...
export var Cell = function (props) {
  ...
  var cls = classNames((_classNames = {}, _classNames[prefix + "p-cell"] = true, _classNames[prefix + "p-cell-" + type] = type, _classNames)); // Cell 自动判断 Text
...
var Paragraph = function (props) {
  ...
  var cls = classNames((_classNames2 = {}, _classNames2[prefix + "p"] = true, _classNames2[prefix + "p-" + type] = type, _classNames2)); // Cell 自动加 type
