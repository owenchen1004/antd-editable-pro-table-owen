 ...
 */
      ...
      .next-nav.next-normal .next-menu-sub-menu .next-menu-item.next-selected {
        background: #f4f6f9;
        background: var(--nav-normal-sub-nav-selected-bg-color, #f4f6f9);
        color: #03c1fd;
        color: var(--nav-normal-sub-nav-selected-text-color, #03c1fd); }
    ...
    .next-nav.next-normal .next-nav-item.next-menu-item.next-disabled .next-menu-item-text > a {
      color: #8d9299;
      color: var(--nav-normal-item-disabled-text-color, #8d9299);
      cursor: not-allowed; }
  ...
  .next-nav.next-line {
    ...
    border-color: #dcdfe6;
    border-color: var(--nav-line-border-color, #dcdfe6);
    color: #1f2633;
    color: var(--nav-line-text-color, #1f2633);
    font-weight: normal;
    ...
    .next-nav.next-line .next-nav-item.next-menu-item {
      ...
      .next-nav.next-line .next-nav-item.next-menu-item.next-focused, .next-nav.next-line .next-nav-item.next-menu-item:hover {
        ...
        color: #000000;
        color: var(--nav-line-item-hover-text-color, #000000);
        font-weight: bold;
        font-weight: var(--nav-line-item-hover-text-style, bold); }
      .next-nav.next-line .next-nav-item.next-menu-item.next-selected {
        background: transparent;
        background: var(--nav-line-item-selected-bg-color, transparent);
        color: #03c1fd;
        color: var(--nav-line-item-selected-text-color, #03c1fd);
        font-weight: bold;
      ...
      .next-nav.next-line .next-nav-item.next-menu-item.next-opened {
        ...
        color: #03c1fd;
        color: var(--nav-line-item-opened-text-color, #03c1fd); }
      .next-nav.next-line .next-nav-item.next-menu-item.next-child-selected {
        ...
        color: #03c1fd;
        color: var(--nav-line-item-childselected-text-color, #03c1fd); }
      ...
      .next-nav.next-line .next-nav-item.next-menu-item:before {
        background: #03c1fd;
        background: var(--nav-line-item-selected-active-color, #03c1fd); }
      .next-nav.next-line .next-nav-item.next-menu-item:hover:before {
        background: #03c1fd;
        background: var(--nav-line-item-hover-active-color, #03c1fd); }
    ...
    .next-nav.next-line .next-nav-group-label {
      color: #8d9299;
      color: var(--nav-line-group-text-color, #8d9299);
      font-weight: normal;
    ...
    .next-nav.next-line .next-menu-sub-menu .next-menu-item {
      ...
      color: #1f2633;
      color: var(--nav-line-sub-nav-text-color, #1f2633);
      font-weight: normal;
      ...
      .next-nav.next-line .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-line .next-menu-sub-menu .next-menu-item:hover {
        ...
        color: #1f2633;
        color: var(--nav-line-sub-nav-hover-text-color, #1f2633); }
      .next-nav.next-line .next-menu-sub-menu .next-menu-item.next-selected {
        ...
        color: #03c1fd;
        color: var(--nav-line-sub-nav-selected-text-color, #03c1fd); }
    ...
    .next-nav.next-line .next-nav-item.next-menu-item.next-disabled .next-menu-item-text > a {
      color: #8d9299;
      color: var(--nav-line-item-disabled-text-color, #8d9299);
      cursor: not-allowed; }
  ...
  .next-nav.next-icon-only.next-normal .next-nav-icon.next-icon {
    ...
    margin-right: calc(29px - 16px/2 - 20px - 1px);
  ...
  .next-nav.next-icon-only.next-primary .next-nav-icon.next-icon {
    ...
    margin-right: calc(29px - 16px/2 - 20px);
    margin-right: calc(29px - var(--nav-icon-only-font-size, 16px)/2 - var(--nav-ver-item-padding-lr, 20px));
    margin-left: calc(29px - 16px/2 - 20px - 0px);
    ...
    margin-right: calc(29px - 16px/2 - 20px - 0px);
...
.next-number-picker-normal[dir="rtl"] .next-btn:first-child {
  ...
  border-right: 1px solid var(--color-line1-3, #d9dbde);
  border-left: 0;
  border-top-right-radius: 0; }
...
.next-pagination[dir="rtl"] .next-pagination-size-selector-btn.next-btn-text + .next-pagination-size-selector-btn {
  ...
  border-right: var(--line-1, 1px) solid var(--color-line1-2, #dcdfe6); }
...
.next-pagination[dir="rtl"].next-small .next-pagination-item:hover.next-next:not([disabled]) i {
  color: #1f2633;
  color: var(--pagination-arrow-hover-color, #1f2633); }
...
.next-pagination {
  ...
  .next-pagination .next-pagination-item:not([disabled]) {
    ...
    border-color: #d9dbde;
    border-color: var(--pagination-item-border-color, #d9dbde);
    background: #FFFFFF;
    background: var(--pagination-item-bg, #FFFFFF);
    color: #1f2633;
    color: var(--pagination-item-color, #1f2633);
    -webkit-box-shadow: none;
  ...
  .next-pagination .next-pagination-item {
    ...
    .next-pagination .next-pagination-item.next-current {
      border-color: #03c1fd;
      border-color: var(--pagination-item-current-border-color, #03c1fd);
      background: #03c1fd;
      background: var(--pagination-item-current-bg, #03c1fd);
      color: #FFFFFF;
    ...
    .next-pagination .next-pagination-item.next-current:hover, .next-pagination .next-pagination-item.next-current:focus {
      ...
      background: #009dd6;
      background: var(--pagination-item-current-hover-bg, #009dd6);
      color: #FFFFFF;
  ...
  .next-pagination-ellipsis {
    display: inline-block;
    color: #8d9299;
    color: var(--pagination-ellipsis-color, #8d9299);
    vertical-align: top; }
  .next-pagination-display {
    display: inline-block;
    margin: 0 16px;
    color: #1f2633;
    color: var(--pagination-total-color, #1f2633);
    vertical-align: middle; }
    .next-pagination-display em {
      font-style: normal;
      color: #03c1fd;
      color: var(--pagination-current-color, #03c1fd); }
  .next-pagination-jump-text {
    display: inline-block;
    vertical-align: middle;
    color: #8d9299;
    color: var(--pagination-jump-color, #8d9299); }
  ...
  .next-pagination-size-selector {
    ...
    .next-pagination-size-selector-title {
      ...
      color: #8d9299;
      color: var(--pagination-size-selector-title-color, #8d9299); }
    ...
    .next-pagination-size-selector-btn.next-btn-text {
      ...
      .next-pagination-size-selector-btn.next-btn-text.next-current {
        color: #03c1fd;
        color: var(--pagination-size-selector-filter-current-color, #03c1fd); }
      .next-pagination-size-selector-btn.next-btn-text + .next-pagination-size-selector-btn {
        border-left: 1px solid #dcdfe6;
        border-left: var(--line-1, 1px) solid var(--color-line1-2, #dcdfe6); }
  ...
  .next-pagination.next-small.next-no-border .next-pagination-item.next-next:not([disabled]):hover i {
    color: #03c1fd;
    color: var(--pagination-arrow-hover-color-noboder, #03c1fd); }
...
.next-paragraph {
  color: #1f2633;
  color: var(--paragraph-text-color, #1f2633); }
...
.next-progress-line {
  ...
  .next-progress-line {
    ...
    .next-progress-line-underlay {
      ...
      width: 100%;
      background: #f0f2f5;
      background: var(--progress-line-underlay-color, #f0f2f5); }
    .next-progress-line-overlay {
      ...
      .next-progress-line-overlay-normal {
        background: #03c1fd;
        background: var(--progress-line-normal-color, #03c1fd); }
      .next-progress-line-overlay-success {
        background: #08c29e;
        background: var(--progress-line-success-color, #08c29e); }
      .next-progress-line-overlay-error {
        background: #f52743;
        background: var(--progress-line-error-color, #f52743); }
      .next-progress-line-overlay-started {
        background: #f52743;
        background: var(--progress-line-started-color, #f52743); }
      .next-progress-line-overlay-middle {
        background: #f5cb22;
        background: var(--progress-line-middle-color, #f5cb22); }
      .next-progress-line-overlay-finishing {
        background: #08c29e;
        background: var(--progress-line-finishing-color, #08c29e); }
  ...
  .next-progress-line-show-info .next-progress-line-text {
    ...
    display: inline-block;
    color: #1f2633;
    color: var(--progress-line-font-color, #1f2633); }
  .next-progress-line-show-border .next-progress-line-underlay {
    border: 1px solid #dcdfe6;
    border: var(--progress-line-underlay-border-width, 1px) solid var(--progress-line-underlay-border-color, #dcdfe6); }
...
.next-progress-circle {
  ...
  .next-progress-circle {
    ...
    .next-progress-circle-underlay {
      ...
      stroke: #f0f2f5;
      stroke: var(--progress-circle-underlay-color, #f0f2f5); }
    .next-progress-circle-overlay {
      ...
      .next-progress-circle-overlay-normal {
        stroke: #03c1fd;
        stroke: var(--progress-circle-normal-color, #03c1fd); }
      .next-progress-circle-overlay-success {
        stroke: #08c29e;
        stroke: var(--progress-circle-success-color, #08c29e); }
      .next-progress-circle-overlay-error {
        stroke: #f52743;
        stroke: var(--progress-circle-error-color, #f52743); }
      .next-progress-circle-overlay-started {
        stroke: #f52743;
        stroke: var(--progress-circle-started-color, #f52743); }
      .next-progress-circle-overlay-middle {
        stroke: #f5cb22;
        stroke: var(--progress-circle-middle-color, #f5cb22); }
      .next-progress-circle-overlay-finishing {
        stroke: #08c29e;
        stroke: var(--progress-circle-finishing-color, #08c29e); }
  ...
  .next-progress-circle-text {
    ...
    color: #1f2633;
    color: var(--progress-circle-text-color, #1f2633); }
...
.next-range {
  ...
  .next-range .next-range-slider-inner {
    ...
    border-color: #d9dbde;
    border-color: var(--range-normal-slider-border-color, #d9dbde);
    border-radius: 50%;
  ...
  .next-range .next-range-slider.next-range-slider-moving .next-range-slider-inner {
    border: 2px solid #03c1fd;
    border: var(--line-2, 2px) var(--line-solid, solid) var(--range-normal-selected-color, #03c1fd);
  ...
  .next-range .next-range-track {
    background: #d9dbde;
    background: var(--range-normal-unselected-color, #d9dbde); }
    .next-range .next-range-track:hover {
      background: #d9dbde;
      background: var(--range-normal-unselected-color-hover, #d9dbde); }
  .next-range .next-range-selected {
    background: #03c1fd;
    background: var(--range-normal-selected-color, #03c1fd); }
    .next-range .next-range-selected:hover {
      background: #03c1fd;
      background: var(--range-normal-selected-color-hover, #03c1fd); }
  .next-range .next-range-scale .next-range-scale-item {
    border-color: #d9dbde;
    border-color: var(--range-normal-unselected-color, #d9dbde);
    background: #d9dbde;
    background: var(--range-normal-unselected-color, #d9dbde); }
    .next-range .next-range-scale .next-range-scale-item:hover {
      border-color: #d9dbde;
      border-color: var(--range-normal-unselected-color-hover, #d9dbde); }
    .next-range .next-range-scale .next-range-scale-item.activated {
      border-color: #03c1fd;
      border-color: var(--range-normal-selected-color, #03c1fd);
      background: #03c1fd;
      background: var(--range-normal-selected-color, #03c1fd); }
      .next-range .next-range-scale .next-range-scale-item.activated:hover {
        border-color: #03c1fd;
        border-color: var(--range-normal-selected-color-hover, #03c1fd); }
  .next-range .next-range-slider-inner {
    background: #FFFFFF;
  ...
  .next-range .next-range-mark .next-range-mark-text {
    color: #8d9299;
    color: var(--range-normal-mark-color, #8d9299); }
    .next-range .next-range-mark .next-range-mark-text:hover {
      color: #8d9299;
      color: var(--range-normal-mark-color-hover, #8d9299); }
    .next-range .next-range-mark .next-range-mark-text.activated {
      color: #1f2633;
      color: var(--range-normal-mark-selected-color, #1f2633); }
      .next-range .next-range-mark .next-range-mark-text.activated:hover {
        color: #1f2633;
        color: var(--range-normal-mark-selected-color-hover, #1f2633); }
  .next-range.disabled .next-range-track {
    background: #d9dbde;
    background: var(--range-normal-unselected-color-disabled, #d9dbde); }
  .next-range.disabled .next-range-selected {
    background: #c4c7cc;
    background: var(--range-normal-selected-color-disabled, #c4c7cc); }
  .next-range.disabled .next-range-scale-item {
    border-color: #d9dbde;
    border-color: var(--range-normal-unselected-color-disabled, #d9dbde); }
    .next-range.disabled .next-range-scale-item.activated {
      border-color: #c4c7cc;
      border-color: var(--range-normal-selected-color-disabled, #c4c7cc); }
  .next-range.disabled .next-range-slider-inner {
    background: #e4e8ee;
    background: var(--range-normal-slider-bg-color-disabled, #e4e8ee);
    border-color: #e4e8ee;
    border-color: var(--range-normal-slider-border-color-disabled, #e4e8ee);
  ...
  .next-range.disabled .next-range-mark-text {
    color: #c4c7cc;
    color: var(--range-normal-mark-color-disabled, #c4c7cc); }
    .next-range.disabled .next-range-mark-text.activated {
      color: #8d9299;
      color: var(--range-normal-mark-selected-color-disabled, #8d9299); }
  .next-range .next-range-track {
    height: 4px;
  ...
  .next-range .next-range-slider {
    ...
    -webkit-box-shadow: var(--range-size-m-slider-shadow, 1px 1px 4px 0px rgba(0, 0, 0, 0.16));
            box-shadow: 1px 1px 4px 0px rgba(0, 0, 0, 0.16);
            box-shadow: var(--range-size-m-slider-shadow, 1px 1px 4px 0px rgba(0, 0, 0, 0.16)); }
  .next-range .next-range-slider-inner {
    height: 16px;
    height: var(--range-size-m-slider-hw, 16px);
    width: 16px;
  ...
  .next-range.simulation-click > .next-range-slider-inner {
    border: 2px solid #03c1fd;
    border: 2px solid var(--range-normal-selected-color, #03c1fd);
    -webkit-box-shadow: 2px 4px 16px 0px rgba(0, 0, 0, 0.12);
            box-shadow: 2px 4px 16px 0px rgba(0, 0, 0, 0.12);
    -webkit-transform: scale(1.2);
        -ms-transform: scale(1.2);
...
.next-rating {
  ...
  .next-rating-underlay {
    ...
    .next-rating-underlay .next-icon {
      color: #edeff2;
      color: var(--rating-normal-underlay-color, #edeff2); }
  .next-rating-stroke-mode .next-rating-underlay .next-icon {
    color: transparent;
    -webkit-text-stroke: 1px #03c1fd;
    -webkit-text-stroke: 1px var(--rating-normal-overlay-color, #03c1fd); }
  .next-rating-overlay {
    white-space: nowrap;
    overflow: hidden;
    position: absolute;
    ...
    .next-rating-overlay .next-icon {
      color: #03c1fd;
      color: var(--rating-normal-overlay-color, #03c1fd); }
  ...
  .next-rating-info {
    ...
    border: 1px solid var(--color-fill1-4, #edeff2);
    background: #FFFFFF;
    padding: 4px 8px 3px;
    font-size: 12px;
    white-space: nowrap; }
  ...
  .next-rating:focus .next-rating-base:not(.next-rating-base-disabled), .next-rating.hover {
    ...
    .next-rating:focus .next-rating-base:not(.next-rating-base-disabled) .next-rating-overlay .next-icon, .next-rating.hover .next-rating-overlay .next-icon {
      color: #03c1fd;
      color: var(--rating-normal-overlay-hover-color, #03c1fd); }

/* 状态 */
/* ======================================== */
.next-rating-grade-low .next-rating-overlay .next-icon {
  color: #585d66;
  color: var(--rating-grade-low-overlay-color, #585d66); }
...
.next-rating-grade-high .next-rating-overlay .next-icon {
  color: #03c1fd;
  color: var(--rating-grade-high-overlay-color, #03c1fd); }

.next-rating-grade-high.hover .next-rating-overlay .next-icon {
  color: #03c1fd;
  color: var(--rating-grade-high-overlay-hover-color, #03c1fd); }
...
.next-search-simple[dir=rtl].next-normal .next-search-left .next-search-left-addon {
  ...
  border-left: 1px solid var(--search-simple-normal-split-color, #d9dbde);
  border-right: none; }

.next-search-simple[dir=rtl].next-dark .next-search-left {
  border-color: #d9dbde;
  border-color: var(--search-simple-dark-color, #d9dbde); }
  .next-search-simple[dir=rtl].next-dark .next-search-left .next-search-left-addon {
    border-right: 1px solid #d9dbde;
    border-right: 1px solid var(--search-simple-dark-split-color, #d9dbde); }

.next-search-simple[dir=rtl].next-dark:hover .next-search-left {
  border-color: #d9dbde;
  border-color: var(--search-simple-dark-hover-color, #d9dbde); }

.next-search-simple[dir=rtl].next-dark .next-search-icon {
  color: #8d9299;
  color: var(--search-simple-dark-icon-text-color, #8d9299); }
  .next-search-simple[dir=rtl].next-dark .next-search-icon:hover {
    color: #585d66;
    color: var(--search-simple-dark-icon-hover-text-color, #585d66); }
...
.next-search-normal[dir=rtl].next-primary .next-search-left .next-search-left-addon {
  ...
  border-left: 1px solid var(--search-normal-primary-split-color, #e4e8ee);
  border-right: none; }
...
.next-search-normal[dir=rtl].next-secondary .next-search-left .next-search-left-addon {
  border-left: 1px solid #e4e8ee;
  border-left: 1px solid var(--search-normal-secondary-split-color, #e4e8ee);
  border-right: none; }
...
.next-search-normal[dir=rtl].next-normal .next-search-left .next-search-left-addon {
  border-left: 1px solid #e4e8ee;
  border-left: 1px solid var(--search-normal-normal-split-color, #e4e8ee);
  border-right: none; }

.next-search-normal[dir=rtl].next-dark .next-search-left .next-search-left-addon {
  border-left: 1px solid #03c1fd;
  border-left: 1px solid var(--search-normal-dark-color, #03c1fd);
  border-right: none; }
...
.next-search {
  ...
  .next-search-normal {
    ...
    .next-search-normal.next-primary .next-search-left {
      border-color: #03c1fd;
      border-color: var(--search-normal-primary-color, #03c1fd); }
      .next-search-normal.next-primary .next-search-left .next-search-left-addon {
        border-right: 1px solid #e4e8ee;
        border-right: 1px solid var(--search-normal-primary-split-color, #e4e8ee); }
    .next-search-normal.next-primary:hover .next-search-left,
    .next-search-normal.next-primary:hover .next-btn {
      border-color: #03c1fd;
      border-color: var(--search-normal-primary-hover-color, #03c1fd); }
    .next-search-normal.next-primary .next-search-btn {
      background: #03c1fd;
      background: var(--search-normal-primary-color, #03c1fd);
      border-color: #03c1fd;
      border-color: var(--search-normal-primary-color, #03c1fd);
      color: #FFFFFF;
      ...
      .next-search-normal.next-primary .next-search-btn:hover {
        background: #009dd6;
        background: var(--search-normal-primary-btn-hover-bg-color, #009dd6);
        border-color: #03c1fd;
        border-color: var(--search-normal-primary-hover-color, #03c1fd);
        color: #FFFFFF;
    ...
    .next-search-normal.next-secondary .next-search-left {
      border-color: #d9dbde;
      border-color: var(--search-normal-secondary-color, #d9dbde); }
      .next-search-normal.next-secondary .next-search-left .next-search-left-addon {
        border-right: 1px solid #e4e8ee;
        border-right: 1px solid var(--search-normal-secondary-split-color, #e4e8ee); }
    .next-search-normal.next-secondary:hover .next-search-left,
    .next-search-normal.next-secondary:hover .next-btn {
      border-color: #03c1fd;
      border-color: var(--search-normal-secondary-hover-color, #03c1fd); }
    .next-search-normal.next-secondary .next-search-btn {
      background: #03c1fd;
      background: var(--search-normal-secondary-btn-bg-color, #03c1fd);
      border-color: #03c1fd;
      border-color: var(--search-normal-secondary-btn-bg-color, #03c1fd);
      color: #FFFFFF;
      color: var(--search-normal-secondary-btn-text-color, #FFFFFF); }
      .next-search-normal.next-secondary .next-search-btn:hover {
        background: #009dd6;
        background: var(--search-normal-secondary-btn-hover-bg-color, #009dd6);
        border-color: #03c1fd;
        border-color: var(--search-normal-secondary-hover-color, #03c1fd);
        color: #FFFFFF;
    ...
    .next-search-normal.next-normal .next-search-left {
      border-color: #d9dbde;
      border-color: var(--search-normal-normal-color, #d9dbde); }
      .next-search-normal.next-normal .next-search-left .next-search-left-addon {
        border-right: 1px solid #e4e8ee;
        border-right: 1px solid var(--search-normal-normal-split-color, #e4e8ee); }
    ...
    .next-search-normal.next-normal .next-search-btn {
      background: #f5f7fa;
      background: var(--search-normal-normal-btn-bg-color, #f5f7fa);
      border-color: #d9dbde;
      border-color: var(--search-normal-normal-color, #d9dbde);
      color: #585d66;
      ...
      .next-search-normal.next-normal .next-search-btn:hover {
        background: #f0f2f5;
        background: var(--search-normal-normal-btn-hover-bg-color, #f0f2f5);
        border-color: #c4c7cc;
        border-color: var(--search-normal-normal-hover-color, #c4c7cc);
        color: #1f2633;
        color: var(--search-normal-normal-btn-hover-text-color, #1f2633); }
    ...
    .next-search-normal.next-dark .next-search-left {
      border-color: #03c1fd;
      border-color: var(--search-normal-dark-color, #03c1fd); }
      .next-search-normal.next-dark .next-search-left .next-search-left-addon {
        border-right: 1px solid #03c1fd;
        border-right: 1px solid var(--search-normal-dark-color, #03c1fd); }
    .next-search-normal.next-dark:hover .next-search-left,
    .next-search-normal.next-dark:hover .next-btn {
      border-color: #03c1fd;
      border-color: var(--search-normal-dark-hover-color, #03c1fd); }
    .next-search-normal.next-dark .next-search-btn {
      background: #03c1fd;
      background: var(--search-normal-dark-color, #03c1fd);
      border-color: #03c1fd;
      border-color: var(--search-normal-dark-color, #03c1fd);
      color: #FFFFFF;
      ...
      .next-search-normal.next-dark .next-search-btn:hover {
        background: #009dd6;
        background: var(--search-normal-dark-btn-hover-bg-color, #009dd6);
        border-color: #03c1fd;
        border-color: var(--search-normal-dark-hover-color, #03c1fd);
        color: #FFFFFF;
  ...
  .next-search-simple {
    ...
    .next-search-simple.next-normal .next-search-left {
      border-color: #d9dbde;
      border-color: var(--search-simple-normal-color, #d9dbde); }
      .next-search-simple.next-normal .next-search-left .next-search-left-addon {
        border-right: 1px solid #d9dbde;
        border-right: 1px solid var(--search-simple-normal-split-color, #d9dbde); }
    .next-search-simple.next-normal:hover .next-search-left {
      border-color: #c4c7cc;
      border-color: var(--search-simple-normal-hover-color, #c4c7cc); }
    .next-search-simple.next-normal .next-search-icon {
      color: #8d9299;
      color: var(--search-simple-normal-icon-text-color, #8d9299); }
      .next-search-simple.next-normal .next-search-icon:hover {
        color: #585d66;
        color: var(--search-simple-normal-icon-hover-text-color, #585d66); }
    .next-search-simple.next-normal .next-search-left {
      border-width: 1px;
  ...
  .next-slick-arrow {
    ...
    .next-slick-arrow.inner {
      ...
      .next-slick-arrow.inner.disabled {
        color: #c4c7cc;
        color: var(--slick-arrow-icon-color-disabled, #c4c7cc);
        background: #f5f7fa;
        background: var(--slick-arrow-bg-color-disabled, #f5f7fa);
        opacity: 0.5;
    ...
    .next-slick-arrow.outer {
      ...
      .next-slick-arrow.outer:focus, .next-slick-arrow.outer:hover {
        color: #1f2633;
        color: var(--slick-arrow-icon-color-hover-outer, #1f2633);
        background: transparent;
      ...
      .next-slick-arrow.outer.disabled {
        color: #c4c7cc;
        color: var(--slick-arrow-icon-color-disabled-outer, #c4c7cc);
        background: transparent;
...
.next-split-btn {
  ...
  .next-split-btn-trigger.next-btn-normal:not(:disabled):not(.disabled) .next-icon {
    color: #8d9299;
    color: var(--split-btn-trigger-normal-icon-color, #8d9299); }
...
.next-step-arrow {
  ...
  .next-step-arrow > .next-step-item-wait {
    background: #f0f2f5;
    background: var(--step-arrow-item-wait-background, #f0f2f5); }
    ...
    .next-step-arrow > .next-step-item-wait .next-step-item-tail-underlay {
      background: #c4c7cc;
      background: var(--color-text1-1, #c4c7cc); }
    ...
    .next-step-arrow > .next-step-item-wait .next-step-item-title {
      color: #8d9299;
      color: var(--step-arrow-item-title-wait-color, #8d9299);
    ...
    .next-step-arrow > .next-step-item-wait:before {
      border: calc(32px/2) solid #f0f2f5;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-wait-background, #f0f2f5);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-wait:after {
      border-left-color: #f0f2f5;
      border-left-color: var(--step-arrow-item-wait-background, #f0f2f5); }
  .next-step-arrow > .next-step-item-process {
    background: #03c1fd;
    background: var(--step-arrow-item-process-background, #03c1fd); }
    ...
    .next-step-arrow > .next-step-item-process:before {
      border: calc(32px/2) solid #03c1fd;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-process-background, #03c1fd);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-process:after {
      border-left-color: #03c1fd;
      border-left-color: var(--step-arrow-item-process-background, #03c1fd); }
  .next-step-arrow > .next-step-item-finish {
    background: #e6fdff;
    background: var(--step-arrow-item-finish-background, #e6fdff); }
    ...
    .next-step-arrow > .next-step-item-finish .next-step-item-title {
      color: #03c1fd;
      color: var(--step-arrow-item-title-finish-color, #03c1fd);
      word-break: break-word; }
    ...
    .next-step-arrow > .next-step-item-finish:before {
      border: calc(32px/2) solid #e6fdff;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-finish-background, #e6fdff);
      border-left-color: transparent; }
    .next-step-arrow > .next-step-item-finish:after {
      border-left-color: #e6fdff;
      border-left-color: var(--step-arrow-item-finish-background, #e6fdff); }
  .next-step-arrow .next-step-item-disabled {
    cursor: not-allowed;
    background: #f5f7fa;
    background: var(--step-arrow-item-disabled-background, #f5f7fa); }
    ...
    .next-step-arrow .next-step-item-disabled:before {
      border: calc(32px/2) solid #f5f7fa;
      border: calc(var(--step-arrow-item-height, 32px)/2) solid var(--step-arrow-item-disabled-background, #f5f7fa);
      border-left-color: transparent; }
    .next-step-arrow .next-step-item-disabled:after {
      border-left-color: #f5f7fa;
      border-left-color: var(--step-arrow-item-disabled-background, #f5f7fa); }
...
.next-step-circle .next-step-item-container {
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-text {
    color: #03c1fd;
    color: var(--step-circle-item-node-process-percent-color, #03c1fd);
    font-size: 14px;
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-underlay {
    stroke: #c4c7cc;
    stroke: var(--step-circle-item-node-wait-border-color, #c4c7cc);
  ...
  .next-step-circle .next-step-item-container .next-step-item-progress .next-progress-circle-overlay-normal {
    stroke: #03c1fd;
    stroke: var(--step-circle-item-node-finish-border-color, #03c1fd);
    stroke-width: calc(1px*3);
    stroke-width: calc(var(--step-circle-item-node-border-width, 1px)*3); }
...
.next-step-circle > .next-step-item-wait .next-step-item-tail-overlay {
  background: #d9dbde;
  background: var(--step-circle-item-tail-wait-color, #d9dbde); }

.next-step-circle > .next-step-item-wait .next-step-item-tail-underlay {
  background: #e4e8ee;
  background: var(--step-circle-item-tail-bg-color, #e4e8ee); }
...
.next-step-circle > .next-step-item-wait > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #c4c7cc;
  border-color: var(--step-circle-item-node-wait-border-color, #c4c7cc); }
...
.next-step-circle > .next-step-item-process .next-step-item-tail-overlay {
  background: #d9dbde;
  background: var(--step-circle-item-tail-process-color, #d9dbde); }
...
.next-step-circle > .next-step-item-process > .next-step-item-container .next-step-item-node-circle {
  background: #03c1fd;
  background: var(--step-circle-item-node-process-background, #03c1fd);
  border-color: #03c1fd;
  border-color: var(--step-circle-item-node-process-border-color, #03c1fd); }
...
.next-step-circle > .next-step-item-process .next-step-item-title {
  color: #1f2633;
  color: var(--step-circle-item-title-process-color, #1f2633);
  word-break: break-word; }
...
.next-step-circle > .next-step-item-finish .next-step-item-tail-overlay {
  background: #03c1fd;
  background: var(--step-circle-item-tail-finish-color, #03c1fd); }
...
.next-step-circle > .next-step-item-finish > .next-step-item-container .next-step-item-node {
  color: #03c1fd;
  color: var(--step-circle-item-node-finish-color, #03c1fd); }
...
.next-step-circle > .next-step-item-finish > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #03c1fd;
  border-color: var(--step-circle-item-node-finish-border-color, #03c1fd); }
...
.next-step-circle .next-step-item-disabled .next-step-item-tail-overlay {
  background: #e4e8ee;
  background: var(--step-circle-item-tail-disabled-color, #e4e8ee); }
...
.next-step-circle .next-step-item-disabled > .next-step-item-container .next-step-item-node {
  color: #c4c7cc;
  color: var(--step-circle-item-node-disabled-color, #c4c7cc); }
...
.next-step-circle .next-step-item-disabled > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #e4e8ee;
  border-color: var(--step-circle-item-node-disabled-border-color, #e4e8ee); }
...
.next-step-dot > .next-step-item-wait .next-step-item-tail-overlay {
  background: #d9dbde;
  background: var(--step-dot-item-tail-wait-color, #d9dbde); }

.next-step-dot > .next-step-item-wait .next-step-item-tail-underlay {
  background: #e4e8ee;
  background: var(--step-dot-item-tail-bg-color, #e4e8ee); }
...
.next-step-dot > .next-step-item-wait > .next-step-item-container .next-step-item-node {
  color: #8d9299;
  color: var(--step-dot-item-node-wait-color, #8d9299); }
...
.next-step-dot > .next-step-item-wait > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #c4c7cc;
  border-color: var(--step-dot-item-node-wait-border-color, #c4c7cc); }
...
.next-step-dot > .next-step-item-process .next-step-item-tail-overlay {
  background: #d9dbde;
  background: var(--step-dot-item-tail-process-color, #d9dbde); }
...
.next-step-dot > .next-step-item-process > .next-step-item-container .next-step-item-node {
  color: #03c1fd;
  color: var(--step-dot-item-node-process-color, #03c1fd); }

.next-step-dot > .next-step-item-process > .next-step-item-container .next-step-item-node-circle {
  background: #03c1fd;
  background: var(--step-dot-item-node-process-background, #03c1fd);
  border-color: #03c1fd;
  border-color: var(--step-dot-item-node-process-border-color, #03c1fd); }
...
.next-step-dot > .next-step-item-process .next-step-item-title {
  color: #1f2633;
  color: var(--step-dot-item-title-process-color, #1f2633);
  word-break: break-word; }
...
.next-step-dot > .next-step-item-finish .next-step-item-tail-overlay {
  background: #03c1fd;
  background: var(--step-dot-item-tail-finish-color, #03c1fd); }
...
.next-step-dot > .next-step-item-finish > .next-step-item-container .next-step-item-node {
  color: #03c1fd;
  color: var(--step-dot-item-node-finish-color, #03c1fd); }
...
.next-step-dot > .next-step-item-finish > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #03c1fd;
  border-color: var(--step-dot-item-node-finish-border-color, #03c1fd); }
...
.next-step-dot .next-step-item-disabled .next-step-item-tail-overlay {
  background: #e4e8ee;
  background: var(--step-dot-item-tail-disabled-color, #e4e8ee); }
...
.next-step-dot .next-step-item-disabled > .next-step-item-container .next-step-item-node {
  color: #e4e8ee;
  color: var(--step-dot-item-node-disabled-color, #e4e8ee); }
...
.next-step-dot .next-step-item-disabled > .next-step-item-container .next-step-item-node-circle {
  ...
  border-color: #dcdfe6;
  border-color: var(--step-dot-item-node-disabled-border-color, #dcdfe6); }
...
.next-step-arrow[dir="rtl"] > .next-step-item-wait {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-wait:after {
    ...
    border-right-color: var(--step-arrow-item-wait-background, #f0f2f5);
    border-left-color: transparent; }
...
.next-step-arrow[dir="rtl"] > .next-step-item-process {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-process:after {
    border-right-color: #03c1fd;
    border-right-color: var(--step-arrow-item-process-background, #03c1fd);
    border-left-color: transparent; }
...
.next-step-arrow[dir="rtl"] > .next-step-item-finish {
  ...
  .next-step-arrow[dir="rtl"] > .next-step-item-finish:after {
    border-right-color: #e6fdff;
    border-right-color: var(--step-arrow-item-finish-background, #e6fdff);
    border-left-color: transparent; }
...
.next-step-arrow[dir="rtl"] .next-step-item-disabled {
  ...
  .next-step-arrow[dir="rtl"] .next-step-item-disabled:after {
    ...
    border-right-color: var(--step-arrow-item-disabled-background, #f5f7fa);
    border-left-color: transparent; }
...
.next-switch-on[disabled][dir="rtl"]:after {
  ...
  -webkit-box-shadow: var(--switch-on-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16));
          box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.16);
          box-shadow: var(--switch-on-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16)); }
...
.next-switch-off[dir="rtl"]:after {
  ...
  -webkit-box-shadow: var(--switch-rtl-on-shadow, -1px 0px 4px 0px rgba(0, 0, 0, 0.16));
          box-shadow: -1px 0px 4px 0px rgba(0, 0, 0, 0.16);
          box-shadow: var(--switch-rtl-on-shadow, -1px 0px 4px 0px rgba(0, 0, 0, 0.16)); }
...
.next-switch {
  ...
  .next-switch-loading {
    ...
    .next-switch-loading .next-icon-loading {
      color: #03c1fd;
      color: var(--color-brand1-6, #03c1fd);
      text-align: center;
  ...
  .next-switch-on {
    ...
    background-color: var(--switch-normal-on-bg-color, #03c1fd); }
    ...
    .next-switch-on:focus, .next-switch-on.hover, .next-switch-on:hover {
      ...
      background-color: var(--switch-hover-on-bg-color, #009dd6); }
  ...
  .next-switch-on[disabled] {
    ...
    background-color: var(--switch-disabled-on-bg-color, #f0f2f5);
    cursor: not-allowed; }
    .next-switch-on[disabled] .next-switch-btn {
      ...
      background-color: var(--switch-disabled-on-trigger-bg-color, #f5f7fa);
      border-color: transparent;
      border-color: var(--switch-handle-disabled-border-color, transparent); }
    .next-switch-on[disabled] > .next-switch-children {
      color: #c4c7cc;
      color: var(--switch-disabled-on-color-font, #c4c7cc); }
  .next-switch-off {
    background-color: #f0f2f5;
    background-color: var(--switch-normal-off-bg-color, #f0f2f5);
    border-color: #f0f2f5;
    border-color: var(--switch-normal-off-border-color, #f0f2f5); }
    .next-switch-off:focus, .next-switch-off.hover, .next-switch-off:hover {
      background-color: #f0f2f5;
      background-color: var(--switch-hover-off-bg-color, #f0f2f5);
      border-color: #f0f2f5;
      border-color: var(--switch-hover-off-border-color, #f0f2f5); }
    ...
    .next-switch-off > .next-switch-children {
      color: #8d9299;
      color: var(--switch-normal-off-color-font, #8d9299); }
  .next-switch-off[disabled] {
    background-color: #f0f2f5;
    background-color: var(--switch-disabled-off-bg-color, #f0f2f5);
    cursor: not-allowed; }
    .next-switch-off[disabled] .next-switch-btn {
      -webkit-box-shadow: 1px 1px 4px 0px rgba(0, 0, 0, 0.16);
      -webkit-box-shadow: var(--switch-off-shadow, 1px 1px 4px 0px rgba(0, 0, 0, 0.16));
              box-shadow: 1px 1px 4px 0px rgba(0, 0, 0, 0.16);
              box-shadow: var(--switch-off-shadow, 1px 1px 4px 0px rgba(0, 0, 0, 0.16));
      background-color: #f5f7fa;
      background-color: var(--switch-disabled-off-trigger-bg-color, #f5f7fa);
      border-color: transparent;
      border-color: var(--switch-handle-disabled-border-color, transparent); }
    .next-switch-off[disabled] > .next-switch-children {
      color: #d9dbde;
      color: var(--switch-disabled-off-color-font, #d9dbde); }
...
.next-tabs {
  ...
  .next-tabs-tab {
    ...
    .next-tabs-tab .next-tabs-tab-close {
      ...
      .next-tabs-tab .next-tabs-tab-close:hover {
        color: #1f2633;
        color: var(--tab-close-icon-color-hover, #1f2633); }
      .next-tabs-tab .next-tabs-tab-close:focus {
        outline: none; }
    .next-tabs-tab.active .next-tabs-tab-close {
      color: #03c1fd;
      color: var(--tab-close-icon-color-selected, #03c1fd); }
    .next-tabs-tab.disabled .next-tabs-tab-close {
      color: #dcdfe6;
      color: var(--tab-close-icon-color-disabled, #dcdfe6); }
  .next-tabs-tab:focus {
    outline: none; }
  .next-tabs-tabpane {
    visibility: hidden;
  ...
  .next-tabs-btn-down, .next-tabs-btn-prev, .next-tabs-btn-next {
    ...
    .next-tabs-btn-down, .next-tabs-btn-down:link, .next-tabs-btn-down:visited, .next-tabs-btn-down.visited, .next-tabs-btn-prev, .next-tabs-btn-prev:link, .next-tabs-btn-prev:visited, .next-tabs-btn-prev.visited, .next-tabs-btn-next, .next-tabs-btn-next:link, .next-tabs-btn-next:visited, .next-tabs-btn-next.visited {
      color: #585d66;
      color: var(--tab-nav-arrow-color-normal, #585d66); }
    .next-tabs-btn-down:focus, .next-tabs-btn-down:hover, .next-tabs-btn-down.hover, .next-tabs-btn-prev:focus, .next-tabs-btn-prev:hover, .next-tabs-btn-prev.hover, .next-tabs-btn-next:focus, .next-tabs-btn-next:hover, .next-tabs-btn-next.hover {
      color: #1f2633;
      color: var(--tab-nav-arrow-color-hover, #1f2633);
      background: transparent;
      border-color: transparent;
      text-decoration: none; }
    ...
    .next-tabs-btn-down.disabled, .next-tabs-btn-prev.disabled, .next-tabs-btn-next.disabled {
      cursor: not-allowed;
      color: #dcdfe6;
      color: var(--tab-nav-arrow-color-disabled, #dcdfe6); }
  .next-tabs-btn-next {
    right: 8px;
  ...
  .next-tabs-pure > .next-tabs-bar {
    ...
    border-bottom: var(--line-solid, solid) var(--tab-pure-divider-line-width, 1px) var(--tab-pure-divider-border-color, #dcdfe6);
    background-color: transparent;
  ...
  .next-tabs-wrapped > .next-tabs-bar {
    ...
    .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab {
      color: #585d66;
      color: var(--tab-wrapped-text-color, #585d66);
      background-color: #f4f6f9;
      background-color: var(--tab-wrapped-bg-color, #f4f6f9); }
      .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab:hover {
        cursor: pointer;
        color: #1f2633;
        color: var(--tab-wrapped-text-color-hover, #1f2633);
        background-color: #f0f2f5;
        background-color: var(--tab-wrapped-bg-color-hover, #f0f2f5); }
      .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab.active {
        z-index: 1;
        color: #03c1fd;
        color: var(--tab-wrapped-text-color-selected, #03c1fd);
        background-color: #FFFFFF;
      ...
      .next-tabs-wrapped > .next-tabs-bar .next-tabs-tab.disabled {
        ...
        cursor: default;
        color: #c4c7cc;
        color: var(--tab-wrapped-text-color-disabled, #c4c7cc);
        background: #f5f7fa;
        background: var(--tab-wrapped-bg-color-disabled, #f5f7fa); }
  ...
  .next-tabs-wrapped.next-tabs-top > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab {
      ...
      border: var(--tab-wrapped-border-line-style, solid) var(--tab-wrapped-border-line-width, 1px) var(--tab-wrapped-border-line-color, #dcdfe6);
      ...
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab:hover {
        border-color: #d9dbde;
        border-color: var(--tab-wrapped-border-line-color-hover, #d9dbde); }
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab.active {
        border-color: #dcdfe6 #dcdfe6 #FFFFFF #dcdfe6;
        border-color: var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #dcdfe6); }
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 4px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 4px);
        width: 0;
        border-top: 2px solid #03c1fd;
        border-top: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #03c1fd);
        left: 50%;
        top: calc(0px - 1px);
      ...
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab.active:before {
        ...
        width: calc(100% - var(--tab-wrapped-tab-corner-radius, 4px)*2);
        left: 4px;
        left: var(--tab-wrapped-tab-corner-radius, 4px); }
      .next-tabs-wrapped.next-tabs-top > .next-tabs-bar .next-tabs-tab.active {
        border-width: 1px 1px 1px 1px;
  ...
  .next-tabs-wrapped.next-tabs-top > .next-tabs-bar:before {
    ...
    border-bottom: var(--tab-wrapped-content-border-line-width, 1px) var(--tab-wrapped-content-border-line-style, solid) var(--tab-wrapped-border-line-color, #dcdfe6);
  ...
  .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab {
      ...
      .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab.active {
        border-color: #FFFFFF #dcdfe6 #dcdfe6 #dcdfe6;
        border-color: var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6); }
      .next-tabs-wrapped.next-tabs-bottom > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 4px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 4px);
        width: 0;
        border-bottom: 2px solid #03c1fd;
        border-bottom: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #03c1fd);
        left: 50%;
        bottom: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-left > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab {
      ...
      .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab.active {
        border-color: #dcdfe6 #FFFFFF #dcdfe6 #dcdfe6;
        border-color: var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-bg-color-selected, #FFFFFF) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6); }
      .next-tabs-wrapped.next-tabs-left > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 4px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 4px);
        height: 0;
        border-left: 2px solid #03c1fd;
        border-left: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #03c1fd);
        top: 50%;
        left: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-left > .next-tabs-content {
    ...
    border-left: 1px solid #dcdfe6;
    border-left: var(--tab-wrapped-content-border-line-width, 1px) var(--tab-wrapped-content-border-line-style, solid) var(--tab-wrapped-border-line-color, #dcdfe6); }
  .next-tabs-wrapped.next-tabs-right > .next-tabs-bar {
    ...
    .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab {
      ...
      .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab.active {
        border-color: #dcdfe6 #dcdfe6 #dcdfe6 #FFFFFF;
        border-color: var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-border-line-color, #dcdfe6) var(--tab-wrapped-bg-color-selected, #FFFFFF); }
      .next-tabs-wrapped.next-tabs-right > .next-tabs-bar .next-tabs-tab:before {
        border-radius: 4px;
        border-radius: var(--tab-wrapped-tab-corner-radius, 4px);
        height: 0;
        border-right: 2px solid #03c1fd;
        border-right: var(--tab-wrapped-ink-bar-width, 2px) solid var(--tab-wrapped-ink-bar-color, #03c1fd);
        top: 50%;
        right: calc(0px - 1px);
  ...
  .next-tabs-wrapped.next-tabs-right > .next-tabs-content {
    ...
    right: calc(0px - var(--tab-wrapped-border-line-width, 1px));
    border-right: 1px solid #dcdfe6;
    border-right: var(--tab-wrapped-content-border-line-width, 1px) var(--tab-wrapped-content-border-line-style, solid) var(--tab-wrapped-border-line-color, #dcdfe6); }
  .next-tabs-capsule > .next-tabs-bar .next-tabs-tab {
    -webkit-transition: background-color 100ms linear;
    transition: background-color 100ms linear;
    border: 1px solid #d9dbde;
    border: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
    border-right-color: transparent;
    margin-right: calc(0px - 1px);
    margin-right: calc(0px - var(--tab-capsule-tab-border-line-width, 1px));
    color: #1f2633;
    color: var(--tab-capsule-text-color, #1f2633);
    background-color: #f4f6f9;
    background-color: var(--tab-capsule-bg-color, #f4f6f9); }
    ...
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:last-child {
      ...
      border-right: 1px solid #d9dbde;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.active {
      border-right: 1px solid #d9dbde;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
      border-color: #03c1fd;
      border-color: var(--tab-capsule-tab-border-line-color-active, #03c1fd); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.disabled {
      border-color: #e4e8ee;
      border-color: var(--tab-capsule-tab-border-line-color-disabled, #e4e8ee); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:hover {
      z-index: 2;
      border-right: 1px solid #d9dbde;
      border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
      border-color: #d9dbde;
      border-color: var(--tab-capsule-tab-border-line-color-hover, #d9dbde); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab:hover {
      cursor: pointer;
      color: #1f2633;
      color: var(--tab-capsule-text-color-hover, #1f2633);
      background-color: #f0f2f5;
      background-color: var(--tab-capsule-bg-color-hover, #f0f2f5); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.active {
      z-index: 1;
      color: #FFFFFF;
      color: var(--tab-capsule-text-color-selected, #FFFFFF);
      background-color: #03c1fd;
      background-color: var(--tab-capsule-bg-color-selected, #03c1fd); }
    .next-tabs-capsule > .next-tabs-bar .next-tabs-tab.disabled {
      pointer-events: none;
      cursor: default;
      color: #c4c7cc;
      color: var(--tab-capsule-text-color-disabled, #c4c7cc);
      background: #f5f7fa;
      background: var(--tab-capsule-bg-color-disabled, #f5f7fa); }
  .next-tabs-text > .next-tabs-bar .next-tabs-tab {
    color: #585d66;
    color: var(--tab-text-text-color-normal, #585d66);
    background-color: transparent; }
    .next-tabs-text > .next-tabs-bar .next-tabs-tab:hover {
      cursor: pointer;
      color: #1f2633;
      color: var(--tab-text-text-color-hover, #1f2633);
      background-color: transparent; }
    .next-tabs-text > .next-tabs-bar .next-tabs-tab.active {
      z-index: 1;
      color: #03c1fd;
      color: var(--tab-text-text-color-selected, #03c1fd);
      background-color: transparent; }
    .next-tabs-text > .next-tabs-bar .next-tabs-tab.disabled {
      pointer-events: none;
      cursor: default;
      color: #c4c7cc;
      color: var(--tab-text-text-color-disabled, #c4c7cc);
      background: transparent; }
    .next-tabs-text > .next-tabs-bar .next-tabs-tab:not(:last-child):after {
      ...
      background-color: var(--tab-text-item-sep-color, #dcdfe6); }
  .next-tabs-pure > .next-tabs-bar {
    position: relative; }
...
.next-tabs[dir='rtl'].next-tabs-capsule > .next-tabs-bar .next-tabs-tab {
  ...
  border-top: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
  border-bottom: 1px solid #d9dbde;
  border-bottom: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
  border-right: 1px solid #d9dbde;
  border-right: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde);
  border-left: 0; }
  ...
  .next-tabs[dir='rtl'].next-tabs-capsule > .next-tabs-bar .next-tabs-tab:last-child {
    ...
    border-radius: var(--tab-capsule-corner-radius, 4px) 0 0 var(--tab-capsule-corner-radius, 4px);
    border-left: 1px solid #d9dbde;
    border-left: var(--tab-capsule-tab-border-line-width, 1px) var(--tab-capsule-tab-border-line-style, solid) var(--tab-capsule-tab-border-line-color, #d9dbde); }
...
.next-tag-checkable.next-tag-level-secondary {
  color: #1f2633;
  color: var(--tag-normal-text-color, #1f2633);
  border-color: transparent;
  background-color: transparent; }
  .next-tag-checkable.next-tag-level-secondary:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-secondary:not(.disabled):not([disabled]).hover {
    color: #03c1fd;
    color: var(--tag-normal-text-color-hover, #03c1fd); }

.next-tag-default.next-tag-level-primary {
  color: #585d66;
  color: var(--tag-fill-text-color, #585d66);
  border-color: #f0f2f5;
  border-color: var(--tag-fill-border-color, #f0f2f5);
  background-color: #f0f2f5;
  background-color: var(--tag-fill-bg-color, #f0f2f5); }
  .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-fill-text-color-hover, #1f2633);
    border-color: #edeff2;
    border-color: var(--tag-fill-border-color-hover, #edeff2);
    background-color: #edeff2;
    background-color: var(--tag-fill-bg-color-hover, #edeff2); }
    .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]):hover > .next-tag-close-btn, .next-tag-default.next-tag-level-primary:not(.disabled):not([disabled]).hover > .next-tag-close-btn {
      color: #1f2633;
      color: var(--tag-fill-tail-color-hover, #1f2633); }
  .next-tag-default.next-tag-level-primary[disabled], .disabled.next-tag-default.next-tag-level-primary {
    color: #c4c7cc;
    color: var(--tag-fill-text-color-disabled, #c4c7cc);
    border-color: #f5f7fa;
    border-color: var(--tag-fill-border-color-disabled, #f5f7fa);
    background-color: #f5f7fa;
    background-color: var(--tag-fill-bg-color-disabled, #f5f7fa); }
    .next-tag-default.next-tag-level-primary[disabled] > .next-tag-close-btn, .disabled.next-tag-default.next-tag-level-primary > .next-tag-close-btn {
      color: #c4c7cc;
      color: var(--tag-fill-tail-color-disabled, #c4c7cc); }
...
.next-tag-closable.next-tag-level-primary {
  color: #585d66;
  color: var(--tag-closable-primary-fill-text-color, #585d66);
  border-color: #f0f2f5;
  border-color: var(--tag-closable-primary-fill-border-color, #f0f2f5);
  background-color: #f0f2f5;
  background-color: var(--tag-closable-primary-fill-bg-color, #f0f2f5); }
  .next-tag-closable.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-closable.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-closable-primary-fill-text-color-hover, #1f2633);
    border-color: #edeff2;
    border-color: var(--tag-closable-primary-fill-border-color-hover, #edeff2);
    background-color: #edeff2;
    background-color: var(--tag-closable-primary-fill-bg-color-hover, #edeff2); }
  ...
  .next-tag-closable.next-tag-level-primary[disabled], .disabled.next-tag-closable.next-tag-level-primary {
    color: #c4c7cc;
    color: var(--tag-closable-primary-fill-text-color-disabled, #c4c7cc);
    border-color: #f5f7fa;
    border-color: var(--tag-closable-primary-fill-border-color-disabled, #f5f7fa);
    background-color: #f5f7fa;
    background-color: var(--tag-closable-primary-fill-bg-color-disabled, #f5f7fa); }
...
.next-tag-checkable.next-tag-level-primary {
  ...
  border-color: #f0f2f5;
  border-color: var(--tag-checkable-fill-border-color, #f0f2f5);
  background-color: #f0f2f5;
  background-color: var(--tag-checkable-fill-bg-color, #f0f2f5); }
  .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-checkable-fill-text-color-hover, #1f2633);
    border-color: #edeff2;
    border-color: var(--tag-checkable-fill-border-color-hover, #edeff2);
    background-color: #edeff2;
    background-color: var(--tag-checkable-fill-bg-color-hover, #edeff2); }
    .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]):hover > .next-tag-close-btn, .next-tag-checkable.next-tag-level-primary:not(.disabled):not([disabled]).hover > .next-tag-close-btn {
      color: #1f2633;
      color: var(--tag-checkable-fill-tail-color-hover, #1f2633); }
  .next-tag-checkable.next-tag-level-primary[disabled], .disabled.next-tag-checkable.next-tag-level-primary {
    color: #c4c7cc;
    color: var(--tag-checkable-fill-text-color-disabled, #c4c7cc);
    border-color: #f5f7fa;
    border-color: var(--tag-checkable-fill-border-color-disabled, #f5f7fa);
    background-color: #f5f7fa;
    background-color: var(--tag-checkable-fill-bg-color-disabled, #f5f7fa); }
    .next-tag-checkable.next-tag-level-primary[disabled] > .next-tag-close-btn, .disabled.next-tag-checkable.next-tag-level-primary > .next-tag-close-btn {
      color: #c4c7cc;
      color: var(--tag-checkable-fill-tail-color-disabled, #c4c7cc); }
...
.next-tag-checkable.next-tag-level-primary.checked {
  ...
  border-color: #03c1fd;
  border-color: var(--tag-checkable-primary-border-color, #03c1fd);
  background-color: #03c1fd;
  background-color: var(--tag-checkable-primary-bg-color, #03c1fd); }
  .next-tag-checkable.next-tag-level-primary.checked:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-primary.checked:not(.disabled):not([disabled]).hover {
    ...
    border-color: #009dd6;
    border-color: var(--tag-checkable-primary-border-color-hover, #009dd6);
    background-color: #009dd6;
    background-color: var(--tag-checkable-primary-bg-color-hover, #009dd6); }
  ...
  .next-tag-checkable.next-tag-level-primary.checked[disabled], .disabled.next-tag-checkable.next-tag-level-primary.checked {
    color: #c4c7cc;
    color: var(--tag-checkable-primary-text-color-disabled, #c4c7cc);
    border-color: #f0f2f5;
    border-color: var(--tag-checkable-primary-border-color-disabled, #f0f2f5);
    background-color: #f0f2f5;
    background-color: var(--tag-checkable-primary-bg-color-disabled, #f0f2f5); }
...
.next-tag-default.next-tag-level-normal {
  ...
  border-color: #d9dbde;
  border-color: var(--tag-bordered-border-color, #d9dbde);
  background-color: transparent;
  ...
  .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-bordered-text-color-hover, #1f2633);
    border-color: #c4c7cc;
    border-color: var(--tag-bordered-border-color-hover, #c4c7cc);
    background-color: transparent;
    ...
    .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]):hover > .next-tag-close-btn, .next-tag-default.next-tag-level-normal:not(.disabled):not([disabled]).hover > .next-tag-close-btn {
      color: #1f2633;
      color: var(--tag-bordered-tail-color-hover, #1f2633); }
  .next-tag-default.next-tag-level-normal[disabled], .disabled.next-tag-default.next-tag-level-normal {
    color: #c4c7cc;
    color: var(--tag-bordered-text-color-disabled, #c4c7cc);
    border-color: #e4e8ee;
    border-color: var(--tag-bordered-border-color-disabled, #e4e8ee);
    background-color: #f5f7fa;
    background-color: var(--tag-bordered-bg-disabled, #f5f7fa); }
    .next-tag-default.next-tag-level-normal[disabled] > .next-tag-close-btn, .disabled.next-tag-default.next-tag-level-normal > .next-tag-close-btn {
      color: #c4c7cc;
      color: var(--tag-bordered-tail-color-disabled, #c4c7cc); }
...
.next-tag-closable.next-tag-level-normal {
  color: #585d66;
  color: var(--tag-closable-bordered-text-color, #585d66);
  border-color: #d9dbde;
  border-color: var(--tag-closable-bordered-border-color, #d9dbde);
  background-color: transparent;
  ...
  .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-closable-bordered-text-color-hover, #1f2633);
    border-color: #c4c7cc;
    border-color: var(--tag-closable-bordered-border-color-hover, #c4c7cc);
    background-color: transparent;
    ...
    .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]):hover > .next-tag-close-btn, .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]).hover > .next-tag-close-btn {
      color: #1f2633;
      color: var(--tag-closable-bordered-tail-color-hover, #1f2633); }
  .next-tag-closable.next-tag-level-normal[disabled], .disabled.next-tag-closable.next-tag-level-normal {
    color: #c4c7cc;
    color: var(--tag-closable-bordered-text-color-disabled, #c4c7cc);
    border-color: #e4e8ee;
    border-color: var(--tag-closable-bordered-border-color-disabled, #e4e8ee);
    background-color: transparent;
    ...
    .next-tag-closable.next-tag-level-normal[disabled] > .next-tag-close-btn, .disabled.next-tag-closable.next-tag-level-normal > .next-tag-close-btn {
      color: #c4c7cc;
      color: var(--tag-closable-bordered-tail-color-disabled, #c4c7cc); }
  .next-tag-closable.next-tag-level-normal > .next-tag-close-btn {
    color: #585d66;
    color: var(--tag-closable-bordered-tail-color, #585d66); }

.next-tag-checkable.next-tag-level-normal.checked {
  color: #03c1fd;
  color: var(--tag-secondary-text-color, #03c1fd);
  border-color: #03c1fd;
  border-color: var(--tag-secondary-border-color, #03c1fd);
  background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]).hover {
    color: #009dd6;
    color: var(--tag-secondary-text-color-hover, #009dd6);
    border-color: #009dd6;
    border-color: var(--tag-secondary-border-color-hover, #009dd6);
    background-color: transparent;
...
.next-tag-checkable.next-tag-level-secondary.checked:before {
  ...
  background-color: #03c1fd;
  background-color: var(--tag-checkable-secondary-bg-selected, #03c1fd);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-checkable.next-tag-level-secondary.checked:not(.disabled):not([disabled]):hover:before, .next-tag-checkable.next-tag-level-secondary.checked:not(.disabled):not([disabled]).hover:before {
  background-color: #009dd6;
  background-color: var(--tag-checkable-secondary-bg-selected-hover, #009dd6); }
...
.next-tag-checkable.next-tag-level-secondary.checked[disabled]:before, .next-tag-checkable.next-tag-level-secondary.checked:disabled:before {
  ...
  background-color: var(--tag-checkable-secondary-bg-selected-disabled, #e4e8ee); }
...
.next-tag-checkable.next-tag-level-normal {
  ...
  border-color: #d9dbde;
  border-color: var(--tag-checkable-normal-border-color, #d9dbde);
  background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal:not(.disabled):not([disabled]):hover, .next-tag-checkable.next-tag-level-normal:not(.disabled):not([disabled]).hover {
    color: #1f2633;
    color: var(--tag-checkable-normal-text-color-hover, #1f2633);
    border-color: #d9dbde;
    border-color: var(--tag-checkable-normal-border-color-hover, #d9dbde);
    background-color: transparent;
  ...
  .next-tag-checkable.next-tag-level-normal[disabled], .disabled.next-tag-checkable.next-tag-level-normal {
    color: #c4c7cc;
    color: var(--tag-checkable-normal-text-selected-disabled, #c4c7cc);
    border-color: #e4e8ee;
    border-color: var(--tag-checkable-normal-border-selected-disabled, #e4e8ee);
    background-color: #f5f7fa;
    background-color: var(--tag-checkable-normal-bg-selected-disabled, #f5f7fa); }
...
.next-tag-checkable.next-tag-level-normal.checked:before {
  ...
  -webkit-font-smoothing: antialiased;
  background-color: #03c1fd;
  background-color: var(--tag-checkable-normal-bg-selected, #03c1fd);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]):hover:before, .next-tag-checkable.next-tag-level-normal.checked:not(.disabled):not([disabled]).hover:before {
  background-color: #009dd6;
  background-color: var(--tag-checkable-normal-bg-selected-hover, #009dd6); }
...
.next-tag-checkable.next-tag-level-normal.checked[disabled]:before, .next-tag-checkable.next-tag-level-normal.checked:disabled:before {
  background-color: #e4e8ee;
  background-color: var(--tag-checkable-normal-tick-bg-selected-disabled, #e4e8ee); }
...
.next-tag-closable.next-tag-level-normal:before {
  ...
  background-color: var(--tag-closable-normal-bg, #d9dbde);
  -webkit-transform: rotate(45deg);
      -ms-transform: rotate(45deg);
          transform: rotate(45deg); }
...
.next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]):hover:before, .next-tag-closable.next-tag-level-normal:not(.disabled):not([disabled]).hover:before {
  ...
  background-color: var(--tag-closable-normal-bg-hover, #c4c7cc); }
...
.next-tag-closable.next-tag-level-normal[disabled]:before, .next-tag-closable.next-tag-level-normal:disabled:before {
  background-color: #e4e8ee;
  background-color: var(--tag-closable-normal-bg-disabled, #e4e8ee); }
...
.next- {
  ...
  .next-tag-medium {
    ...
    .next-tag-medium.next-tag-closable > .next-tag-body {
      ...
      max-width: calc(100% - 12px - 16px - 12px);
  ...
  .next-tag-checkable {
    ...
    .next-tag-checkable.next-tag-level-secondary[disabled], .next-tag-checkable.next-tag-level-secondary.disabled {
      color: #c4c7cc;
      color: var(--tag-text-color-disabled, #c4c7cc);
      border-color: #e4e8ee;
      border-color: var(--tag-border-color-disabled, #e4e8ee);
      background-color: #f5f7fa;
      background-color: var(--tag-fill-bg-color-disabled, #f5f7fa); }
...
.next-timeline[dir='rtl'] .next-timeline-item {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-dot-tail {
    ...
    border-right: var(--timeline-item-tail-size, 1px) dotted var(--timeline-item-tail-color, #dcdfe6); }
...
.next-timeline[dir='rtl'] .next-timeline-item-done {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-timeline {
    ...
    .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-timeline .next-timeline-item-tail {
      ...
      .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-timeline .next-timeline-item-tail i {
        ...
        position: relative;
        background: #dcdfe6;
        background: var(--timeline-item-tail-color, #dcdfe6);
        -webkit-transition: all 100ms linear;
        transition: all 100ms linear; }
  .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-content {
    ...
    .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-content .next-timeline-item-title {
      ...
      line-height: calc(14px + 4px);
      line-height: calc(var(--timeline-item-title-font-size, 14px) + 4px);
      margin-top: 4px;
      ...
      white-space: nowrap;
      color: #1f2633;
      color: var(--timeline-item-title-color, #1f2633);
      text-align: right; }
    ...
    .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-content .next-timeline-item-time {
      ...
      color: #8d9299;
      color: var(--timeline-item-time-color, #8d9299);
      text-align: right; }
  .next-timeline[dir='rtl'] .next-timeline-item-done.next-timeline-item-has-left-content > .next-timeline-item-left-content {
    ...
    color: #8d9299;
    color: var(--timeline-item-left-body-color, #8d9299);
    line-height: calc(12px + 4px);
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-done .next-timeline-item-dot {
    background: #d9dbde;
    background: var(--timeline-item-done-background, #d9dbde); }
...
.next-timeline[dir='rtl'] .next-timeline-item-process {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-process .next-timeline-item-dot {
    background: #03c1fd;
    background: var(--timeline-item-process-background, #03c1fd); }
...
.next-timeline[dir='rtl'] .next-timeline-item-success {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-success .next-timeline-item-dot {
    background: #08c29e;
    background: var(--timeline-item-success-background, #08c29e); }
...
.next-timeline[dir='rtl'] .next-timeline-item-error {
  ...
  .next-timeline[dir='rtl'] .next-timeline-item-error .next-timeline-item-dot {
    background: #f52743;
    background: var(--timeline-item-error-background, #f52743); }
...
.next-timeline-item {
  ...
  .next-timeline-item-dot-tail {
    ...
    border-left: var(--timeline-item-tail-size, 1px) dotted var(--timeline-item-tail-color, #dcdfe6); }
...
.next-transfer {
  ...
  .next-transfer-panel {
    display: inline-block;
    border: 1px solid #dcdfe6;
    border: var(--transfer-panel-border-width, 1px) var(--line-solid, solid) var(--transfer-panel-border-color, #dcdfe6);
    border-radius: 4px;
  ...
  .next-transfer-panel-header {
    ...
    border-bottom: 1px solid #dcdfe6;
    border-bottom: var(--transfer-panel-border-width, 1px) var(--line-solid, solid) var(--transfer-panel-border-color, #dcdfe6);
    background-color: #f5f7fa;
    background-color: var(--transfer-panel-header-background-color, #f5f7fa);
    color: #1f2633;
    color: var(--transfer-panel-header-text-color, #1f2633);
    font-size: 14px;
  ...
  .next-transfer-panel-not-found {
    ...
    text-align: center;
    color: #8d9299;
    color: var(--color-text1-2, #8d9299);
    font-size: 14px;
    font-size: var(--font-size-body-2, 14px); }
  ...
  .next-transfer-panel-item:not(.next-disabled).next-simple:hover {
    color: #03c1fd;
    color: var(--transfer-simple-panel-item-hover-text-color, #03c1fd); }
  .next-transfer-panel-item.next-insert-before:before {
    ...
    content: '';
    width: 100%;
    border-top: 1px solid #03c1fd;
    border-top: var(--line-1, 1px) solid var(--color-brand1-6, #03c1fd); }
  .next-transfer-panel-item.next-insert-after:after {
    ...
    content: '';
    width: 100%;
    border-bottom: 1px solid #03c1fd;
    border-bottom: var(--line-1, 1px) solid var(--color-brand1-6, #03c1fd); }
  .next-transfer-panel-footer {
    ...
    border-top: var(--transfer-panel-border-width, 1px) var(--line-solid, solid) var(--transfer-panel-border-color, #dcdfe6);
    background-color: #FFFFFF;
  ...
  .next-transfer-panel-count {
    ...
    vertical-align: middle;
    color: #1f2633;
    color: var(--transfer-panel-footer-text-color, #1f2633); }
  .next-transfer-panel-move-all {
    font-size: 14px;
    font-size: var(--font-size-body-1, 14px);
    color: #03c1fd;
    color: var(--transfer-simple-panel-footer-text-color, #03c1fd);
    cursor: pointer; }
    .next-transfer-panel-move-all.next-disabled {
      color: #c4c7cc;
      color: var(--color-text1-1, #c4c7cc);
      cursor: not-allowed; }
  ...
  .next-transfer-move.next-icon {
    color: #d9dbde;
    color: var(--transfer-simple-move-icon-color, #d9dbde); }
...
.next-tree {
  ...
  .next-tree-node-indent-unit {
    ...
    .next-tree-node-indent-unit.next-line::before {
      ...
      display: inline-block;
      border-left: 1px solid #d9dbde;
      border-left: var(--tree-line-width, 1px) var(--tree-line-style, solid) var(--tree-line-color, #d9dbde);
  ...
  .next-tree-switcher.next-noline {
    ...
    .next-tree-switcher.next-noline .next-tree-switcher-icon {
      ...
      transition: transform 100ms linear, -webkit-transform 100ms linear;
      color: #8d9299;
      color: var(--tree-switch-arrow-color, #8d9299); }
  ...
  .next-tree-switcher.next-line {
    ...
    border: 1px solid #d9dbde;
    border: var(--tree-switch-border-width, 1px) var(--line-solid, solid) var(--tree-switch-border-color, #d9dbde);
    border-radius: 4px;
    ...
    .next-tree-switcher.next-line .next-tree-switcher-icon {
      margin-left: calc(16px/2 - 6px - 1px*2/2);
    ...
    .next-tree-switcher.next-line:not(.next-disabled):hover {
      border-color: #c4c7cc;
      border-color: var(--tree-switch-hover-border-color, #c4c7cc);
      background-color: #f4f6f9;
      background-color: var(--tree-switch-hover-bg-color, #f4f6f9); }
      .next-tree-switcher.next-line:not(.next-disabled):hover .next-tree-switcher-icon {
        color: #1f2633;
        color: var(--tree-switch-hover-icon-color, #1f2633); }
    .next-tree-switcher.next-line.next-disabled {
      border-color: #e4e8ee;
      border-color: var(--color-line1-1, #e4e8ee);
      background-color: #FFFFFF;
      cursor: not-allowed; }
  ...
  .next-tree-switcher.next-noop-line-noroot {
    height: 0;
    border-left: 1px solid #d9dbde;
    border-left: var(--tree-switch-border-width, 1px) var(--line-solid, solid) var(--tree-line-color, #d9dbde);
    border-bottom: 1px solid #d9dbde;
    border-bottom: var(--tree-line-width, 1px) var(--tree-line-style, solid) var(--tree-line-color, #d9dbde); }
  ...
  .next-tree.next-node-indent .next-tree-node-inner {
    ...
    .next-tree.next-node-indent .next-tree-node-inner:focus .next-tree-node-label {
      color: #1f2633;
      color: var(--tree-node-hover-color, #1f2633);
      background-color: #f4f6f9;
      background-color: var(--tree-node-hover-bg-color, #f4f6f9); }
  ...
  .next-tree.next-node-indent .next-tree-node-label {
    ...
    cursor: default;
    color: #1f2633;
    color: var(--tree-node-normal-color, #1f2633);
    background-color: #FFFFFF;
  ...
  .next-tree.next-node-indent .next-tree-node-inner.next-selected .next-tree-node-label {
    color: #1f2633;
    color: var(--tree-node-selected-color, #1f2633);
    background-color: #e6fdff;
    background-color: var(--tree-node-selected-background, #e6fdff); }
...
.next-tree[dir='rtl'] .next-tree-switcher.next-noop-line-noroot {
  border-left: none;
  border-right: 1px solid #d9dbde;
  border-right: var(--tree-switch-border-width, 1px) var(--line-solid, solid) var(--tree-line-color, #d9dbde); }
...
.next-tree[dir='rtl'] .next-tree-right-angle {
  ...
  border-left: none;
  border-right: 1px solid #d9dbde;
  border-right: var(--tree-line-width, 1px) var(--tree-line-style, solid) var(--tree-line-color, #d9dbde); }
...
.next-tree-select {
  ...
  .next-tree-select-dropdown {
    ...
    border: 1px solid #dcdfe6;
    border: var(--popup-local-border-width, 1px) var(--popup-local-border-style, solid) var(--popup-local-border-color, #dcdfe6);
    border-radius: 4px;
    border-radius: var(--popup-local-corner, 4px);
    -webkit-box-shadow: 0px 4px 16px 0px rgba(0, 0, 0, 0.12);
    -webkit-box-shadow: var(--popup-local-shadow, 0px 4px 16px 0px rgba(0, 0, 0, 0.12));
            box-shadow: 0px 4px 16px 0px rgba(0, 0, 0, 0.12);
            box-shadow: var(--popup-local-shadow, 0px 4px 16px 0px rgba(0, 0, 0, 0.12));
    max-height: 260px;
    overflow: auto; }
...
.next-upload {
  ...
  .next-upload.next-disabled {
    ...
    border-color: var(--color-line1-1, #e4e8ee) !important;
    color: #c4c7cc !important;
    color: var(--color-text1-1, #c4c7cc) !important; }
...
.next-upload-list-text .next-upload-list-item {
  background-color: #f4f6f9;
  background-color: var(--upload-text-list-bg-color, #f4f6f9);
  padding: 4px 8px;
  padding: 4px var(--upload-text-list-padding-left-right, 8px);
  ...
  .next-upload-list-text .next-upload-list-item .next-icon-close {
    color: #8d9299;
    color: var(--upload-text-list-close-icon-color, #8d9299);
    cursor: pointer;
    text-align: center;
    -webkit-transition: all 100ms linear;
    transition: all 100ms linear;
  ...
  .next-upload-list-text .next-upload-list-item:hover {
    background-color: #f4f6f9;
    background-color: var(--upload-text-list-bg-color-hover, #f4f6f9); }
    .next-upload-list-text .next-upload-list-item:hover .next-icon {
      color: #585d66;
      color: var(--upload-text-list-close-icon-color-hover, #585d66); }
  ...
  .next-upload-list-text .next-upload-list-item-name {
    color: #1f2633;
    color: var(--upload-text-list-name-font-color, #1f2633);
    -webkit-transition: all 100ms linear;
    transition: all 100ms linear; }
  .next-upload-list-text .next-upload-list-item-size {
    color: #8d9299;
    color: var(--upload-text-list-size-font-color, #8d9299);
    margin-left: 8px; }
  ...
  .next-upload-list-text .next-upload-list-item-done:hover .next-upload-list-item-name {
    color: #03c1fd;
    color: var(--upload-text-list-name-font-color-hover, #03c1fd); }
  .next-upload-list-text .next-upload-list-item-done:hover .next-upload-list-item-size {
    color: #03c1fd;
    color: var(--upload-text-list-size-font-color-hover, #03c1fd); }
  .next-upload-list-text .next-upload-list-item-error {
    /* stylelint-disable declaration-no-important */
    background-color: #fff0f0 !important;
    background-color: var(--upload-text-list-bg-color-error, #fff0f0) !important; }
    ...
    .next-upload-list-text .next-upload-list-item-error-msg {
      ...
      overflow: hidden;
      color: #f52743;
      color: var(--upload-text-list-error-text-color, #f52743); }

.next-upload-list-image .next-upload-list-item {
  -webkit-box-sizing: content-box;
          box-sizing: content-box;
  border: 1px solid #dcdfe6;
  border: var(--upload-image-list-item-border-width, 1px) solid var(--upload-image-list-item-border-color, #dcdfe6);
  background-color: #FFFFFF;
  ...
  .next-upload-list-image .next-upload-list-item .next-icon-close {
    cursor: pointer;
    color: #8d9299;
    color: var(--upload-image-list-close-icon-color, #8d9299);
    text-align: center; }
  ...
  .next-upload-list-image .next-upload-list-item:hover {
    border-color: #03c1fd;
    border-color: var(--upload-image-list-item-border-color-hover, #03c1fd); }
    .next-upload-list-image .next-upload-list-item:hover .next-icon-close {
      color: #585d66;
      color: var(--upload-image-list-close-icon-color-hover, #585d66); }
  ...
  .next-upload-list-image .next-upload-list-item-thumbnail {
    ...
    border: 1px solid #dcdfe6;
    border: var(--upload-image-list-item-picture-border-width, 1px) solid var(--upload-image-list-item-picture-border-color, #dcdfe6);
    border-radius: 0;
    border-radius: var(--upload-image-list-item-picture-corner, 0);
    background-color: #f4f6f9;
    background-color: var(--upload-image-list-item-picture-background-color, #f4f6f9);
    margin-right: 8px;
    vertical-align: middle;
    text-align: center;
    overflow: hidden;
  ...
  .next-upload-list-image .next-upload-list-item-error {
    border-color: #f52743 !important;
    border-color: var(--upload-image-list-item-border-color-error, #f52743) !important;
    background-color: #FFFFFF;
...
.next-upload-list-card {
  ...
  .next-upload-list-card .next-upload-list-item {
    ...
    .next-upload-list-card .next-upload-list-item-wrapper {
      position: relative;
      border: 1px solid #d9dbde;
      border: 1px solid var(--upload-card-list-border-color, #d9dbde);
      width: 100px;
    ...
    .next-upload-list-card .next-upload-list-item-thumbnail {
      ...
      height: 100%;
      color: #c4c7cc;
      color: var(--upload-card-list-thumbnail-font-color, #c4c7cc);
      font-size: 12px;
    ...
    .next-upload-list-card .next-upload-list-item-uploading .next-upload-list-item-wrapper {
      background-color: #f5f7fa;
      background-color: var(--upload-card-list-uploading-bg-color, #f5f7fa); }
    ...
    .next-upload-list-card .next-upload-list-item-error .next-upload-list-item-wrapper {
      border-color: #f52743;
      border-color: var(--upload-card-list-border-color-error, #f52743); }
...
.next-upload-card {
  ...
  border: 1px var(--upload-card-border-style, dashed) var(--upload-card-border-color, #d9dbde);
  width: 100px;
  width: var(--upload-card-size, 100px);
  height: 100px;
  height: var(--upload-card-size, 100px);
  ...
  .next-upload-card .next-icon {
    color: #d9dbde;
    color: var(--upload-card-icon-color, #d9dbde); }
  ...
  .next-upload-card:hover {
    border-color: #03c1fd;
    border-color: var(--upload-card-hover-border-color, #03c1fd); }
    .next-upload-card:hover .next-icon {
      color: #03c1fd;
      color: var(--upload-card-hover-font-color, #03c1fd); }
...
.next-upload-dragable .next-upload-drag {
  border: 1px dashed #d9dbde;
  border: 1px dashed var(--upload-drag-zone-border-color, #d9dbde);
  -webkit-transition: border-color 100ms linear;
  transition: border-color 100ms linear;
  cursor: pointer;
  border-radius: 4px;
  ...
  .next-upload-dragable .next-upload-drag-hint {
    ...
    color: #8d9299;
    color: var(--upload-drag-zone-upload-normal-hint-color, #8d9299); }
  .next-upload-dragable .next-upload-drag-over {
    border-color: #03c1fd;
    border-color: var(--upload-drag-zone-over-border-color, #03c1fd); }
...
.next-shell {
  ...
  .next-shell-light .next-shell-aside .local-nav-trigger {
    background: #edeff2;
    background: var(--shell-light-local-navigation-background, #edeff2); }
  ...
  .next-shell-light .next-shell-header {
    ...
    border-bottom: var(--shell-light-header-divider-size, 1px) var(--shell-light-header-divider-style, solid) var(--shell-light-header-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-task-header {
    ...
    border-bottom: 1px solid #e4e8ee;
    border-bottom: var(--shell-light-multitask-divider-size, 1px) var(--shell-light-multitask-divider-style, solid) var(--shell-light-multitask-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-main {
    background: #f0f2f5;
    background: var(--shell-light-content-background, #f0f2f5); }
    .next-shell-light .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #e4e8ee;
      border-bottom: var(--shell-light-appbar-divider-size, 1px) var(--shell-light-appbar-divider-style, solid) var(--shell-light-appbar-divider-color, #e4e8ee);
      -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside.next-shell-navigation {
    ...
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-light-navigation-ver-divider-size, 1px) var(--shell-light-navigation-ver-divider-style, solid) var(--shell-light-navigation-ver-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside.next-shell-tooldock {
    ...
    background: #edeff2;
    background: var(--shell-light-tooldock-background, #edeff2);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-light-tooldock-divider-size, 1px) var(--shell-light-tooldock-divider-style, solid) var(--shell-light-tooldock-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside .next-shell-tooldockitem {
    ...
    .next-shell-light .next-shell-aside .next-shell-tooldockitem:hover {
      color: #1f2633;
      color: var(--shell-light-tooldock-item-color-hover, #1f2633);
      background: #f0f2f5;
      background: var(--shell-light-tooldock-item-background-hover, #f0f2f5); }
  .next-shell-light .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-light-local-navigation-background, #edeff2);
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-light-local-navigation-divider-size, 1px) var(--shell-light-local-navigation-divider-style, solid) var(--shell-light-local-navigation-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-light .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-light-ancillary-background, #FFFFFF);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-light-ancillary-divider-size, 1px) var(--shell-light-ancillary-divider-style, solid) var(--shell-light-ancillary-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside .local-nav-trigger {
    background: #edeff2;
    background: var(--shell-dark-local-navigation-background, #edeff2); }
  ...
  .next-shell-dark .next-shell-header {
    ...
    -webkit-box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.16);
    -webkit-box-shadow: var(--shell-dark-header-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16));
            box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.16);
            box-shadow: var(--shell-dark-header-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16));
    padding: 0 16px;
  ...
  .next-shell-dark .next-shell-task-header {
    ...
    border-bottom: 1px solid #e4e8ee;
    border-bottom: var(--shell-dark-multitask-divider-size, 1px) var(--shell-dark-multitask-divider-style, solid) var(--shell-dark-multitask-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-main {
    background: #f0f2f5;
    background: var(--shell-dark-content-background, #f0f2f5); }
    .next-shell-dark .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #e4e8ee;
      border-bottom: var(--shell-dark-appbar-divider-size, 1px) var(--shell-dark-appbar-divider-style, solid) var(--shell-dark-appbar-divider-color, #e4e8ee);
      -webkit-box-shadow: none;
    ...
    .next-shell-dark .next-shell-main .next-shell-footer {
      ...
      color: #c4c7cc;
      color: var(--shell-dark-footer-color, #c4c7cc);
      font-size: 14px;
  ...
  .next-shell-dark .next-shell-aside.next-shell-navigation {
    ...
    background: #1f2633;
    background: var(--shell-dark-navigation-ver-background, #1f2633);
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-dark-navigation-ver-divider-size, 1px) var(--shell-dark-navigation-ver-divider-style, solid) var(--shell-dark-navigation-ver-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside.next-shell-tooldock {
    ...
    background: #edeff2;
    background: var(--shell-dark-tooldock-background, #edeff2);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-dark-tooldock-divider-size, 1px) var(--shell-dark-tooldock-divider-style, solid) var(--shell-dark-tooldock-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside .next-shell-tooldockitem {
    ...
    color: #585d66;
    color: var(--shell-dark-tooldock-item-color, #585d66);
    background: transparent;
    ...
    .next-shell-dark .next-shell-aside .next-shell-tooldockitem:hover {
      color: #1f2633;
      color: var(--shell-dark-tooldock-item-color-hover, #1f2633);
      background: #f0f2f5;
      background: var(--shell-dark-tooldock-item-background-hover, #f0f2f5); }
  .next-shell-dark .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-dark-local-navigation-background, #edeff2);
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-dark-local-navigation-divider-size, 1px) var(--shell-dark-local-navigation-divider-style, solid) var(--shell-dark-local-navigation-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-dark .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-dark-ancillary-background, #FFFFFF);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-dark-ancillary-divider-size, 1px) var(--shell-dark-ancillary-divider-style, solid) var(--shell-dark-ancillary-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-header .nav-trigger {
    background: #03c1fd;
    background: var(--shell-brand-header-background, #03c1fd); }
  .next-shell-brand .next-shell-aside .local-nav-trigger {
    background: #edeff2;
    background: var(--shell-brand-local-navigation-background, #edeff2); }
  ...
  .next-shell-brand .next-shell-header {
    ...
    background: var(--shell-brand-header-background, #03c1fd);
    border-bottom: 1px solid #e4e8ee;
    border-bottom: var(--shell-brand-header-divider-size, 1px) var(--shell-brand-header-divider-style, solid) var(--shell-brand-header-divider-color, #e4e8ee);
    -webkit-box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.16);
    -webkit-box-shadow: var(--shell-brand-header-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16));
            box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.16);
            box-shadow: var(--shell-brand-header-shadow, 0px 1px 4px 0px rgba(0, 0, 0, 0.16));
    padding: 0 16px;
  ...
  .next-shell-brand .next-shell-task-header {
    ...
    border-bottom: 1px solid #e4e8ee;
    border-bottom: var(--shell-brand-multitask-divider-size, 1px) var(--shell-brand-multitask-divider-style, solid) var(--shell-brand-multitask-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-main {
    background: #f0f2f5;
    background: var(--shell-brand-content-background, #f0f2f5); }
    .next-shell-brand .next-shell-main .next-shell-appbar {
      ...
      border-bottom: 1px solid #e4e8ee;
      border-bottom: var(--shell-brand-appbar-divider-size, 1px) var(--shell-brand-appbar-divider-style, solid) var(--shell-brand-appbar-divider-color, #e4e8ee);
      -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside.next-shell-navigation {
    ...
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-brand-navigation-ver-divider-size, 1px) var(--shell-brand-navigation-ver-divider-style, solid) var(--shell-brand-navigation-ver-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside.next-shell-tooldock {
    ...
    background: #edeff2;
    background: var(--shell-brand-tooldock-background, #edeff2);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-brand-tooldock-divider-size, 1px) var(--shell-brand-tooldock-divider-style, solid) var(--shell-brand-tooldock-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside .next-shell-tooldockitem {
    ...
    .next-shell-brand .next-shell-aside .next-shell-tooldockitem:hover {
      color: #1f2633;
      color: var(--shell-brand-tooldock-item-color-hover, #1f2633);
      background: #f0f2f5;
      background: var(--shell-brand-tooldock-item-background-hover, #f0f2f5); }
  .next-shell-brand .next-shell-aside .next-shell-localnavigation {
    ...
    background: var(--shell-brand-local-navigation-background, #edeff2);
    border-right: 1px solid #e4e8ee;
    border-right: var(--shell-brand-local-navigation-divider-size, 1px) var(--shell-brand-local-navigation-divider-style, solid) var(--shell-brand-local-navigation-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
  ...
  .next-shell-brand .next-shell-aside .next-shell-ancillary {
    ...
    background: var(--shell-brand-ancillary-background, #FFFFFF);
    border-left: 1px solid #e4e8ee;
    border-left: var(--shell-brand-ancillary-divider-size, 1px) var(--shell-brand-ancillary-divider-style, solid) var(--shell-brand-ancillary-divider-color, #e4e8ee);
    -webkit-box-shadow: none;
...
.next-typography {
  color: #1f2633;
  color: var(--typography-text-color, #1f2633); }
  ...
  .next-typography mark {
    padding: 0;
    background: #fffbc7;
    background: var(--typography-text-mark-background, #fffbc7);
    color: #1f2633;
    color: var(--typography-text-mark-color, #1f2633); }
  .next-typography strong {
    font-weight: 600;
    font-weight: var(--typography-text-strong-font-weight, 600); }
  .next-typography code {
    background-color: #f4f6f9;
    background-color: var(--typography-text-code-background, #f4f6f9);
    color: #1f2633;
    color: var(--typography-text-code-color, #1f2633);
    border: 1px solid #e4e8ee;
    border: 1px solid var(--typography-text-code-border-color, #e4e8ee);
    margin: 0 .2em;
    padding: .2em .4em .1em;
    font-size: 85%;
    border-radius: 4px;
  ...
  .next-typography a {
    ...
    .next-typography a:link {
      color: #03c1fd;
      color: var(--color-link-1, #03c1fd); }
    .next-typography a:visited {
      color: #007bb0;
      color: var(--color-link-2, #007bb0); }
    .next-typography a:hover {
      color: #009dd6;
      color: var(--color-link-3, #009dd6); }
...
.next-divider {
  ...
  background: #dcdfe6;
  background: var(--divider-hoz-color, #dcdfe6);
  ...
  .next-divider-dashed {
    background: none;
    border-color: #dcdfe6;
    border-color: var(--divider-hoz-color, #dcdfe6);
    border-style: dashed;
  ...
  .next-divider-ver {
    ...
    background: #dcdfe6;
    background: var(--divider-ver-color, #dcdfe6);
    height: .9em;
    margin: 0 8px;
  ...
  .next-divider-hoz.next-divider-with-text-center, .next-divider-hoz.next-divider-with-text-left, .next-divider-hoz.next-divider-with-text-right {
    ...
    color: #1f2633;
    color: var(--divider-hoz-text-color, #1f2633);
    font-weight: normal;
    ...
    .next-divider-hoz.next-divider-with-text-center::before, .next-divider-hoz.next-divider-with-text-center::after, .next-divider-hoz.next-divider-with-text-left::before, .next-divider-hoz.next-divider-with-text-left::after, .next-divider-hoz.next-divider-with-text-right::before, .next-divider-hoz.next-divider-with-text-right::after {
      ...
      width: 50%;
      border-top: 1px solid #dcdfe6;
      border-top: var(--divider-hoz-size, 1px) solid var(--divider-hoz-color, #dcdfe6);
      -webkit-transform: translateY(50%);
          -ms-transform: translateY(50%);
              transform: translateY(50%);
      content: ''; }
...
.next-table {
  ...
  border-top: 1px solid #dcdfe6;
  border-top: var(--table-normal-border-width, 1px) var(--table-normal-border-style, solid) var(--table-normal-border-color, #dcdfe6);
  border-left: 1px solid #dcdfe6;
  border-left: var(--table-normal-border-width, 1px) var(--table-normal-border-style, solid) var(--table-normal-border-color, #dcdfe6); }
  .next-table *,
  .next-table *:before,
  .next-table *:after {
    -webkit-box-sizing: border-box;
  ...
  .next-table th {
    padding: 0;
    background: #f0f2f5;
    background: var(--table-th-bg, #f0f2f5);
    color: #1f2633;
    color: var(--table-th-color, #1f2633);
    text-align: left;
    font-weight: normal;
    font-weight: var(--table-th-font-weight, normal);
    border-right: 1px solid #dcdfe6;
    border-right: var(--table-normal-border-width, 1px) var(--table-normal-border-style, solid) var(--table-normal-border-color, #dcdfe6);
    border-bottom: 1px solid #dcdfe6;
    border-bottom: var(--table-normal-border-width, 1px) var(--table-normal-border-style, solid) var(--table-normal-border-color, #dcdfe6); }
  ...
  .next-table-header-resizable {
    ...
    .next-table-header-resizable .next-table-resize-handler {
      ...
      .next-table-header-resizable .next-table-resize-handler:hover::after {
        z-index: 1;
        background: #03c1fd;
        background: var(--color-brand1-6, #03c1fd); }
  ...
  .next-table.zebra tr:nth-child(even) td {
    background: #f5f7fa;
    background: var(--table-td-gray, #f5f7fa); }
  .next-table.zebra .next-table-row.hovered td {
    background: #f4f6f9;
    background: var(--table-row-hover-bg, #f4f6f9);
    color: #1f2633;
    color: var(--table-row-hover-color, #1f2633); }
  ...
  .next-table.zebra .next-table-row.selected td {
    background: #f4f6f9;
    background: var(--table-row-selected-bg, #f4f6f9);
    color: #1f2633;
    color: var(--table-row-selected-color, #1f2633); }
  .next-table-empty {
    color: #c4c7cc;
  ...
  .next-table-row {
    ...
    background: var(--table-row-bg, #FFFFFF);
    color: #1f2633;
    color: var(--table-row-color, #1f2633); }
...
.next-table-column-resize-proxy {
  ...
  width: 0;
  border-left: 2px solid #03c1fd;
  border-left: var(--line-2, 2px) solid var(--color-brand1-6, #03c1fd);
  z-index: 10;
  display: none; }
...
.next-table-group {
  ...
  .next-table-group.only-bottom-border .next-table-body table.next-table-row {
    border-top: 0; }
  .next-table-group.only-bottom-border .next-table-body table > tbody > tr:nth-last-child(2) td,
  ...
  .next-table-group .next-table-group-header td {
    background: #f0f2f5;
    background: var(--table-group-th-bg, #f0f2f5);
    color: #1f2633;
    color: var(--table-group-th-color, #1f2633); }
  ...
  .next-table-group .next-table-group-footer td {
    background: #f0f2f5;
    background: var(--table-group-footer-bg, #f0f2f5);
    color: #1f2633;
    color: var(--table-group-footer-color, #1f2633); }
...
.next-table-sort {
  ...
  .next-table-sort .next-icon {
    ...
    left: -2px;
    color: #1f2633;
    color: var(--table-sort-color, #1f2633); }
  ...
  .next-table-sort .current .next-icon {
    color: #03c1fd;
    color: var(--table-sort-color-current, #03c1fd); }
...
.next-table-expanded-ctrl {
  ...
  .next-table-expanded-ctrl.disabled {
    color: #8d9299;
    color: var(--table-expanded-ctrl-disabled-color, #8d9299); }
...
.next-calendar2 {
  ...
  .next-calendar2-cell-disabled::before {
    ...
    color: var(--color-text1-1, #c4c7cc);
    background: #f5f7fa;
    background: var(--color-fill1-1, #f5f7fa); }
  ...
  .next-calendar2-card .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today) .next-calendar2-cell-inner, .next-calendar2-panel .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today) .next-calendar2-cell-inner {
    color: #585d66;
    color: var(--color-text1-3, #585d66); }
  .next-calendar2-card .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover:not(.next-calendar2-cell-hover) .next-calendar2-cell-inner, .next-calendar2-panel .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover:not(.next-calendar2-cell-hover) .next-calendar2-cell-inner {
    background: #f4f6f9;
    background: var(--color-fill1-2, #f4f6f9); }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-inner {
    ...
    border-top: 2px solid var(--color-line1-1, #e4e8ee);
    margin: 0 4px;
    padding: 4px 8px 0; }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-current:not(.next-calendar2-cell-disabled):not(.next-calendar2-cell-selected):not(.next-calendar2-cell-today):hover .next-calendar2-cell-inner {
    background-color: #f4f6f9;
    background-color: var(--color-fill1-2, #f4f6f9); }
  ...
  .next-calendar2-fullscreen .next-calendar2-cell-current.next-calendar2-cell-selected:not(.next-calendar2-cell-disabled) .next-calendar2-cell-inner {
    ...
    color: var(--color-brand1-6, #03c1fd);
    background: #e6fdff;
    background: var(--color-brand1-1, #e6fdff); }
  .next-calendar2-card .next-calendar2-header {
    padding: 8px 8px;
    border-bottom: 1px solid #e4e8ee;
    border-bottom: 1px solid var(--color-line1-1, #e4e8ee); }
  .next-calendar2-panel .next-calendar2-header {
    ...
    .next-calendar2-panel .next-calendar2-header-btn > span, .next-calendar2-panel .next-calendar2-header-text-field {
      ...
      font-size: 14px;
      color: #1f2633;
      color: var(--color-text1-4, #1f2633);
      font-weight: bolder;
      vertical-align: initial; }
...
.next-date-picker2-footer {
  ...
  border-top: 1px solid var(--color-line1-1, #e4e8ee);
  padding: 4px 12px;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.next-time-picker2-menu {
  ...
  .next-time-picker2-menu:not(:last-child) {
    border-right: 1px solid #dcdfe6;
    border-right: var(--line-1, 1px) var(--line-solid, solid) var(--color-line1-2, #dcdfe6); }
...
.next-time-picker2-panel {
  ...
  .next-time-picker2-panel-header {
    border-bottom: 1px solid #dcdfe6;
    border-bottom: var(--line-1, 1px) var(--line-solid, solid) var(--popup-local-border-color, #dcdfe6); }
...
.next-time-picker2-wrapper[dir="rtl"] .next-time-picker2-menu {
  ...
  .next-time-picker2-wrapper[dir="rtl"] .next-time-picker2-menu:not(:last-child) {
    border-right: none;
    border-left: 1px solid #dcdfe6;
    border-left: var(--line-1, 1px) var(--line-solid, solid) var(--color-line1-2, #dcdfe6); }
...
.next-time-picker2 {
  ...
  .next-time-picker2-input {
    ...
    -webkit-box-sizing: border-box;
            box-sizing: border-box;
    border: 1px solid #dcdfe6;
    border: var(--input-border-width, 1px) solid var(--input-border-color, #dcdfe6);
    vertical-align: middle;
    width: inherit; }
    ...
    .next-time-picker2-input:hover {
      border-color: #c4c7cc;
      border-color: var(--input-hover-border-color, #c4c7cc);
      background-color: #FFFFFF;
      background-color: var(--input-hover-bg-color, #FFFFFF); }
    .next-time-picker2-input.next-time-picker2-input-focus {
      border-color: #03c1fd;
      border-color: var(--input-focus-border-color, #03c1fd);
      background-color: #FFFFFF;
      background-color: var(--input-focus-bg-color, #FFFFFF);
      -webkit-box-shadow: 0 0 0 2px rgba(3, 193, 253, 0.2);
              box-shadow: 0 0 0 2px rgba(3, 193, 253, 0.2); }
    ...
    .next-time-picker2-input.next-time-picker2-input-disabled {
      ...
      border-color: #e4e8ee;
      border-color: var(--input-disabled-border-color, #e4e8ee);
      background-color: #f5f7fa;
      background-color: var(--input-disabled-bg-color, #f5f7fa);
      cursor: not-allowed; }
  ...
  .next-time-picker2-input-separator {
    color: #dcdfe6;
    color: var(--input-border-color, #dcdfe6);
    font-size: 12px;
    display: inline-block;
    min-width: 16px;
    text-align: center; }
...
div[dir="rtl"] .next-date-time-picker-wrapper {
  border-right: 1px solid #e4e8ee;
  border-right: 1px solid var(--color-line1-1, #e4e8ee);
  border-left: node; }
...
div[dir="rtl"] .next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover:first-of-type::after {
  ...
  border-top-right-radius: 2px;
  border-bottom-right-radius: 2px;
  border-right: 1px dashed #009dd6;
  border-right: 1px dashed var(--color-brand1-9, #009dd6); }
...
div[dir="rtl"] .next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover:last-of-type::after {
  ...
  border-top-left-radius: 2px;
  border-bottom-left-radius: 2px;
  border-left: 1px dashed #009dd6;
  border-left: 1px dashed var(--color-brand1-9, #009dd6); }
...
.next-date-picker2 {
  ...
  .next-date-picker2-wrapper {
    ...
    background-color: #FFFFFF;
    border: 1px solid #e4e8ee;
    border: 1px solid var(--color-line1-1, #e4e8ee);
    border-radius: 4px;
...
.next-range-picker2-arrow {
  ...
  height: 10px;
  margin-left: 16.5px;
  border-color: #e4e8ee #e4e8ee transparent transparent;
  border-color: var(--color-line1-1, #e4e8ee) var(--color-line1-1, #e4e8ee) transparent transparent;
  border-style: solid;
  border-width: 1px;
...
.next-date-time-picker-wrapper {
  border-left: 1px solid #e4e8ee;
  border-left: 1px solid var(--color-line1-1, #e4e8ee); }
...
.next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover::after {
  ...
  -webkit-transform: translateY(-50%);
      -ms-transform: translateY(-50%);
          transform: translateY(-50%);
  border-color: #009dd6 transparent;
  border-color: var(--color-brand1-9, #009dd6) transparent;
  border-style: dashed;
  border-width: 1px; }
...
.next-range-picker2-panel:not(.next-range-picker2-panel-single) .next-calendar2-cell-current:not(.next-calendar2-cell-disabled).next-calendar2-cell-hover-begin::after {
  border-top: 1px dashed #009dd6;
  border-top: 1px dashed var(--color-brand1-9, #009dd6);
  border-left: 1px dashed #009dd6;
  border-left: 1px dashed var(--color-brand1-9, #009dd6);
  border-top-left-radius: 2px;
  border-bottom-left-radius: 2px; }
...
.next-calendar2-table-week .next-calendar2-week-current .next-calendar2-cell.next-calendar2-cell-selected .next-calendar2-cell-inner {
  ...
  color: var(--color-text1-3, #585d66);
  background-color: #e6fdff;
  background-color: var(--color-brand1-1, #e6fdff); }
