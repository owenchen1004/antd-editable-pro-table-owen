...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_881652_syup23f3wm.eot");
  src: url("//at.alicdn.com/t/font_881652_syup23f3wm.eot?#iefix") format("embedded-opentype"), url("//at.alicdn.com/t/font_881652_syup23f3wm.woff2") format("woff2"), url("//at.alicdn.com/t/font_881652_syup23f3wm.woff") format("woff"), url("//at.alicdn.com/t/font_881652_syup23f3wm.ttf") format("truetype"), url("//at.alicdn.com/t/font_881652_syup23f3wm.svg#NextIcon") format("svg"); }
...
.next-loading {
  ...
  .next-loading-fusion-reactor {
    ...
    .next-loading-fusion-reactor .next-loading-dot {
      ...
      border-radius: 50%;
      background: #ff7722;
      background: var(--loading-dot-color, #ff7722);
...
.next-radio-button-large[dir='rtl'] > label:first-child {
  ...
  border-top-right-radius: var(--radio-button-corner-large, 30px);
  border-bottom-right-radius: 30px;
  border-bottom-right-radius: var(--radio-button-corner-large, 30px);
...
.next-radio-button-large[dir='rtl'] > label:last-child {
  ...
  border-top-left-radius: var(--radio-button-corner-large, 30px);
  border-bottom-left-radius: 30px;
  border-bottom-left-radius: var(--radio-button-corner-large, 30px); }
...
.next-radio-button-medium[dir='rtl'] > label:first-child {
  ...
  border-top-right-radius: var(--radio-button-corner-medium, 5px);
  border-bottom-right-radius: 5px;
  border-bottom-right-radius: var(--radio-button-corner-medium, 5px); }
...
.next-radio-button-medium[dir='rtl'] > label:last-child {
  ...
  border-top-left-radius: var(--radio-button-corner-medium, 5px);
  border-bottom-left-radius: 5px;
  border-bottom-left-radius: var(--radio-button-corner-medium, 5px); }
...
.next-radio-button-small[dir='rtl'] > label:first-child {
  ...
  border-bottom-left-radius: 0;
  border-top-right-radius: 5px;
  border-top-right-radius: var(--radio-button-corner-small, 5px);
  border-bottom-right-radius: 5px;
  border-bottom-right-radius: var(--radio-button-corner-small, 5px); }
...
.next-radio-button-small[dir='rtl'] > label:last-child {
  ...
  border-bottom-right-radius: 0;
  border-top-left-radius: 5px;
  border-top-left-radius: var(--radio-button-corner-small, 5px);
  border-bottom-left-radius: 5px;
  border-bottom-left-radius: var(--radio-button-corner-small, 5px); }
...
.next-radio-wrapper {
  ...
  .next-radio-wrapper.checked .next-radio-inner {
    border-color: #ff7722;
    border-color: var(--radio-checked-border-color, #ff7722);
    background: #ff7722;
    background: var(--radio-checked-bg-color, #ff7722); }
  ...
  .next-radio-wrapper:not(.disabled):hover .next-radio-inner, .next-radio-wrapper:not(.disabled).hovered .next-radio-inner {
    border-color: #ff7722;
    border-color: var(--radio-hovered-border-color, #ff7722);
...
.next-radio-button > label {
  ...
  .next-radio-button > label.checked {
    z-index: 11;
    border-color: #ff7722;
    border-color: var(--radio-button-border-color-checked, #ff7722);
    background-color: #FFFFFF;
    background-color: var(--radio-button-bg-color-checked, #FFFFFF); }
    .next-radio-button > label.checked .next-radio-label {
      color: #ff7722;
      color: var(--radio-button-font-color-checked, #ff7722); }
...
.next-badge {
  ...
  .next-badge .next-badge-custom {
    ...
    border-radius: 5px;
    border-radius: var(--badge-size-custom-border-radius, 5px);
    -webkit-transform: translateX(-50%);
        -ms-transform: translateX(-50%);
            transform: translateX(-50%); }
    .next-badge .next-badge-custom > * {
...
.next-balloon {
  ...
  border-radius: 5px;
  border-radius: var(--balloon-corner, 5px);
  font-size: 12px;
  ...
  .next-balloon-title {
    ...
    .next-balloon-title.next-balloon-closable {
      ...
      .next-balloon-title.next-balloon-closable .next-balloon-close {
        ...
        -webkit-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-title-font-size, 16px)/2 - var(--balloon-size-close, 12px)/2));
            -ms-transform: translateY(18px);
            -ms-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-title-font-size, 16px)/2 - var(--balloon-size-close, 12px)/2));
  ...
  .next-balloon-primary {
    ...
    border-color: #ff7722;
    border-color: var(--balloon-primary-color-border, #ff7722);
    background-color: #ff7722;
    background-color: var(--balloon-primary-color-bg, #ff7722);
    -webkit-box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
    -webkit-box-shadow: var(--balloon-primary-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
            box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
            box-shadow: var(--balloon-primary-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    border-width: 1px;
    ...
    .next-balloon-primary .next-balloon-close {
      ...
      -webkit-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-content-font-size, 12px)/2 - var(--balloon-size-close, 12px)/2));
          -ms-transform: translateY(16px);
          -ms-transform: translateY(calc(var(--balloon-size-padding-top, 16px) + var(--balloon-content-font-size, 12px)/2 - var(--balloon-size-close, 12px)/2));
    ...
    .next-balloon-primary:after {
      ...
      border: var(--balloon-primary-border-width, 1px) var(--balloon-border-style, solid) var(--balloon-primary-color-border, #ff7722);
      background-color: #ff7722;
      background-color: var(--balloon-primary-color-bg, #ff7722);
      z-index: -1; }
  ...
  .next-balloon-normal {
    ...
    -webkit-box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
    -webkit-box-shadow: var(--balloon-normal-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
            box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
            box-shadow: var(--balloon-normal-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    border-width: 1px;
...
.next-balloon-tooltip {
  ...
  border-color: #e6e6e6;
  border-color: var(--balloon-tooltip-color-border, #e6e6e6);
  background-color: #f4f4f4;
  background-color: var(--balloon-tooltip-color-bg, #f4f4f4);
  -webkit-box-shadow: none;
  ...
  .next-balloon-tooltip .next-balloon-arrow {
    ...
    .next-balloon-tooltip .next-balloon-arrow .next-balloon-arrow-content {
      ...
      background-color: var(--balloon-tooltip-color-bg, #f4f4f4);
      border: 1px solid #e6e6e6;
      border: var(--balloon-tooltip-border-width, 1px) var(--balloon-tooltip-border-style, solid) var(--balloon-tooltip-color-border, #e6e6e6);
      pointer-events: auto; }
...
.next-breadcrumb {
  ...
  .next-breadcrumb .next-breadcrumb-text {
    ...
    .next-breadcrumb .next-breadcrumb-text > b {
      color: #ff7722;
      color: var(--breadcrumb-text-keyword-color, #ff7722); }
  ...
  .next-breadcrumb .next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover > a {
    color: #ff7722;
    color: var(--breadcrumb-text-color-hover, #ff7722); }
  .next-breadcrumb a.next-breadcrumb-text.activated:hover > a {
    color: #ff7722;
    color: var(--breadcrumb-text-current-color-hover, #ff7722); }
  .next-breadcrumb a.next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover {
    ...
    .next-breadcrumb a.next-breadcrumb-text:not(.next-breadcrumb-text-ellipsis):hover > b {
      color: #ff7722;
      color: var(--breadcrumb-text-keyword-color-hover, #ff7722); }
...
.next-btn {
  ...
  .next-btn {
    ...
    display: inline-block;
    -webkit-box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
    -webkit-box-shadow: var(--btn-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
            box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
            box-shadow: var(--btn-shadow, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    text-decoration: none;
    text-align: center;
    text-transform: none;
    white-space: nowrap;
  ...
  .next-btn.next-small {
    border-radius: 30px;
    border-radius: var(--btn-size-s-corner, 30px);
    padding: 0 8px;
  ...
  .next-btn.next-medium {
    border-radius: 30px;
    border-radius: var(--btn-size-m-corner, 30px);
    padding: 0 12px;
  ...
  .next-btn.next-large {
    border-radius: 30px;
    border-radius: var(--btn-size-l-corner, 30px);
    padding: 0 16px;
  ...
  .next-btn.next-btn-primary {
    ...
    background: #ff7722;
    background: var(--btn-pure-primary-bg, #ff7722);
    border-color: transparent;
    ...
    .next-btn.next-btn-primary:focus, .next-btn.next-btn-primary:hover, .next-btn.next-btn-primary.hover {
      ...
      background: #d95711;
      background: var(--btn-pure-primary-bg-hover, #d95711);
      border-color: transparent;
  ...
  .next-btn.next-btn-secondary {
    ...
    border-color: #ff7722;
    border-color: var(--btn-pure-secondary-border-color, #ff7722); }
    .next-btn.next-btn-secondary, .next-btn.next-btn-secondary:link, .next-btn.next-btn-secondary:visited, .next-btn.next-btn-secondary.visited {
      color: #ff7722;
      color: var(--btn-pure-secondary-color, #ff7722); }
    .next-btn.next-btn-secondary:focus, .next-btn.next-btn-secondary:hover, .next-btn.next-btn-secondary.hover {
      ...
      background: #d95711;
      background: var(--btn-pure-secondary-bg-hover, #d95711);
      border-color: #d95711;
      border-color: var(--btn-pure-secondary-border-color-hover, #d95711);
      text-decoration: none; }
  ...
  .next-btn-text {
    ...
    .next-btn-text.next-btn-primary {
      ...
      .next-btn-text.next-btn-primary, .next-btn-text.next-btn-primary:link, .next-btn-text.next-btn-primary:visited, .next-btn-text.next-btn-primary.visited {
        color: #007ffc;
        color: var(--btn-text-primary-color, #007ffc); }
    ...
    .next-btn-text.next-btn-secondary {
      ...
      .next-btn-text.next-btn-secondary:focus, .next-btn-text.next-btn-secondary:hover, .next-btn-text.next-btn-secondary.hover {
        color: #ff7722;
        color: var(--btn-text-secondary-color-hover, #ff7722);
        background: transparent;
        border-color: transparent;
        text-decoration: none; }
    ...
    .next-btn-text.next-btn-normal {
      ...
      .next-btn-text.next-btn-normal:focus, .next-btn-text.next-btn-normal:hover, .next-btn-text.next-btn-normal.hover {
        color: #ff7722;
        color: var(--btn-text-normal-color-hover, #ff7722);
        background: transparent;
        border-color: transparent;
        text-decoration: none; }
  ...
  .next-btn-ghost {
    ...
    .next-btn-ghost.next-btn-dark {
      ...
      background: rgba(var(--btn-ghost-dark-bg, transparent), 0);
      border-color: #FFFFFF;
      ...
      .next-btn-ghost.next-btn-dark:focus, .next-btn-ghost.next-btn-dark:hover, .next-btn-ghost.next-btn-dark.hover {
        ...
        background: rgba(var(--btn-ghost-dark-bg-hover-rgb, #FFFFFF), var(--btn-ghost-dark-bg-hover-opacity, 0.8));
        border-color: #FFFFFF;
    ...
    .next-btn-ghost.next-btn-light {
      background: rgba(transparent, 0);
      background: rgba(var(--btn-ghost-light-bg, transparent), var(--btn-ghost-light-bg-opacity, 0));
      border-color: #333333;
      ...
      .next-btn-ghost.next-btn-light:focus, .next-btn-ghost.next-btn-light:hover, .next-btn-ghost.next-btn-light.hover {
        ...
        background: rgba(#000000, 0.92);
        background: rgba(var(--btn-ghost-light-bg-hover-rgb, #000000), var(--btn-ghost-light-bg-hover-opacity, 0.92));
        border-color: #333333;
...
.next-input {
  ...
  .next-input.next-input-textarea {
    height: auto;
    border-radius: 5px;
    border-radius: var(--input-multiple-corner, 5px);
    font-size: 0; }
  ...
  .next-input-control .next-input-success-icon {
    color: #00d86a;
    color: var(--input-feedback-success-color, #00d86a); }
  ...
  .next-input-group {
    ...
    .next-input-group > .next-input:first-child.next-small {
      ...
      border-top-left-radius: var(--form-element-small-corner, 30px) !important;
      border-bottom-left-radius: 30px !important;
      border-bottom-left-radius: var(--form-element-small-corner, 30px) !important; }
    .next-input-group > .next-input:first-child.next-medium {
      border-top-left-radius: 30px !important;
      border-top-left-radius: var(--form-element-medium-corner, 30px) !important;
      border-bottom-left-radius: 30px !important;
      border-bottom-left-radius: var(--form-element-medium-corner, 30px) !important; }
    .next-input-group > .next-input:first-child.next-large {
      border-top-left-radius: 30px !important;
      border-top-left-radius: var(--form-element-large-corner, 30px) !important;
      border-bottom-left-radius: 30px !important;
      border-bottom-left-radius: var(--form-element-large-corner, 30px) !important; }
    .next-input-group > .next-input:last-child.next-small {
      border-top-right-radius: 30px !important;
      border-top-right-radius: var(--form-element-small-corner, 30px) !important;
      border-bottom-right-radius: 30px !important;
      border-bottom-right-radius: var(--form-element-small-corner, 30px) !important; }
    .next-input-group > .next-input:last-child.next-medium {
      border-top-right-radius: 30px !important;
      border-top-right-radius: var(--form-element-medium-corner, 30px) !important;
      border-bottom-right-radius: 30px !important;
      border-bottom-right-radius: var(--form-element-medium-corner, 30px) !important; }
    .next-input-group > .next-input:last-child.next-large {
      border-top-right-radius: 30px !important;
      border-top-right-radius: var(--form-element-large-corner, 30px) !important;
      border-bottom-right-radius: 30px !important;
      border-bottom-right-radius: var(--form-element-large-corner, 30px) !important; }
...
.next-calendar-panel-header {
  position: relative;
  background: #ff7722;
  background: var(--calendar-panel-header-background, #ff7722);
  margin-bottom: 8px;
...
.next-calendar-fullscreen .next-calendar-cell {
  ...
  .next-calendar-fullscreen .next-calendar-cell.next-selected .next-calendar-month {
    ...
    color: #ff7722;
    color: var(--calendar-fullscreen-table-cell-select-color, #ff7722);
    border-color: #ff7722;
    border-color: var(--calendar-fullscreen-table-cell-select-border-color, #ff7722); }
...
.next-calendar-fullscreen .next-calendar-date, .next-calendar-fullscreen .next-calendar-month {
  ...
  .next-calendar-fullscreen .next-calendar-date:hover, .next-calendar-fullscreen .next-calendar-month:hover {
    ...
    color: #ff7722;
    color: var(--calendar-fullscreen-table-cell-hover-color, #ff7722);
    border-color: #ff7722;
    border-color: var(--calendar-fullscreen-table-cell-hover-border-color, #ff7722); }
...
.next-calendar-fullscreen .next-calendar-cell-current .next-calendar-month {
  ...
  color: #ff7722;
  color: var(--calendar-fullscreen-table-cell-current-color, #ff7722);
  border-color: #ff7722;
  border-color: var(--calendar-fullscreen-table-cell-current-border-color, #ff7722); }
...
.next-calendar-range .next-calendar-cell {
  ...
  .next-calendar-range .next-calendar-cell.next-selected .next-calendar-year {
    ...
    background: #ff7722;
    background: var(--calendar-card-table-cell-select-background, #ff7722);
    color: #FFFFFF;
    color: var(--calendar-card-table-cell-select-color, #FFFFFF);
    border-color: #ff7722;
    border-color: var(--calendar-card-table-cell-select-border-color, #ff7722); }
  ...
  .next-calendar-range .next-calendar-cell.next-inrange .next-calendar-date {
    ...
    color: #ff7722;
    color: var(--calendar-card-table-cell-inrange-color, #ff7722);
    border-color: #fff7ed;
...
.next-calendar-range .next-calendar-year {
  ...
  .next-calendar-range .next-calendar-year:hover {
    ...
    color: #ff7722;
    color: var(--calendar-card-table-cell-hover-color, #ff7722);
    border-color: #fff7ed;
...
.next-calendar-range .next-calendar-date {
  ...
  margin: 4px auto;
  border-radius: 50%;
  border-radius: var(--calendar-card-table-cell-date-border-radius, 50%); }
...
.next-calendar-range .next-calendar-month {
  ...
  margin: 8px auto;
  border-radius: 30px;
  border-radius: var(--calendar-card-table-cell-month-border-radius, 30px); }
...
.next-calendar-range .next-calendar-year {
  ...
  margin: 8px auto;
  border-radius: 5px;
  border-radius: var(--calendar-card-table-cell-year-border-radius, 5px); }
...
.next-calendar-range .next-calendar-cell-current .next-calendar-year {
  ...
  color: #ff7722;
  color: var(--calendar-card-table-cell-current-color, #ff7722);
  border-color: transparent;
...
.next-card {
  ...
  .next-card {
    ...
    border-radius: 5px;
    border-radius: var(--card-corner, 5px);
    -webkit-box-shadow: none;
  ...
  .next-card-head {
    background: transparent;
    background: var(--card-header-background, transparent);
    padding-left: 16px;
    ...
    .next-card-head-show-bullet .next-card-title:before {
      ...
      background: #ff7722;
      background: var(--card-title-bullet-color, #ff7722);
      position: absolute;
      left: 0;
      top: calc(50% - 8px);
  ...
  .next-card-extra {
    ...
    color: #007ffc;
    color: var(--card-title-extra-color, #007ffc); }
  .next-card-body {
    padding-bottom: 12px;
...
.next-cascader {
  ...
  border-radius: 5px;
  border-radius: var(--cascader-menu-border-radius, 5px); }
  .next-cascader *,
...
.next-checkbox-wrapper {
  ...
  .next-checkbox-wrapper.checked > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.checked.focused > .next-checkbox > .next-checkbox-inner {
    ...
    background-color: #ff7722;
    background-color: var(--checkbox-checked-bg-color, #ff7722); }
  ...
  .next-checkbox-wrapper:not(.disabled):hover > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.hovered > .next-checkbox > .next-checkbox-inner, .next-checkbox-wrapper.focused > .next-checkbox > .next-checkbox-inner {
    border-color: #ff7722;
    border-color: var(--checkbox-hovered-border-color, #ff7722);
    background-color: #fff7ed;
...
.next-collapse {
  ...
  border-radius: 5px;
  border-radius: var(--collapse-border-corner, 5px); }
  .next-collapse *,
  ...
  .next-collapse-panel-title {
    ...
    background: #FFFFFF;
    background: var(--collapse-title-bg-color, #FFFFFF);
    font-size: 14px;
...
.next-message {
  ...
  .next-message.next-message-success.next-inline {
    ...
    background-color: var(--message-success-color-bg-inline, #e6ffee);
    border-color: #e6ffee;
    border-color: var(--message-success-color-border-inline, #e6ffee);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    ...
    .next-message.next-message-success.next-inline .next-message-symbol {
      color: #00d86a;
      color: var(--message-success-color-icon-inline, #00d86a); }
  ...
  .next-message.next-message-success.next-addon {
    ...
    .next-message.next-message-success.next-addon .next-message-symbol {
      color: #00d86a;
      color: var(--message-success-color-icon-addon, #00d86a); }
  ...
  .next-message.next-message-success.next-toast {
    ...
    -webkit-box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
            box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
    border-style: solid;
    border-style: var(--message-border-style-toast, solid); }
    ...
    .next-message.next-message-success.next-toast .next-message-symbol {
      color: #00d86a;
      color: var(--message-success-color-icon-toast, #00d86a); }
  ...
  .next-message.next-message-help.next-inline {
    ...
    background-color: var(--message-help-color-bg-inline, #e6f7ff);
    border-color: #e6f7ff;
    border-color: var(--message-help-color-border-inline, #e6f7ff);
    -webkit-box-shadow: none;
            box-shadow: none;
    border-style: solid;
    border-style: var(--message-border-style, solid); }
    ...
    .next-message.next-message-help.next-inline .next-message-symbol {
      color: #007ffc;
      color: var(--message-help-color-icon-inline, #007ffc); }
  ...
  .next-message.next-message-help.next-addon {
    ...
    .next-message.next-message-help.next-addon .next-message-symbol {
      color: #007ffc;
      color: var(--message-help-color-icon-addon, #007ffc); }
  ...
  .next-message.next-message-help.next-toast {
    ...
    .next-message.next-message-help.next-toast .next-message-symbol {
      color: #007ffc;
      color: var(--message-help-color-icon-toast, #007ffc); }
  ...
  .next-message.next-message-loading.next-inline {
    ...
    .next-message.next-message-loading.next-inline .next-message-symbol {
      color: #ff7722;
      color: var(--message-loading-color-icon-inline, #ff7722); }
  ...
  .next-message.next-message-loading.next-addon {
    ...
    .next-message.next-message-loading.next-addon .next-message-symbol {
      color: #ff7722;
      color: var(--message-loading-color-icon-addon, #ff7722); }
  ...
  .next-message.next-message-loading.next-toast {
    ...
    .next-message.next-message-loading.next-toast .next-message-symbol {
      color: #ff7722;
      color: var(--message-loading-color-icon-toast, #ff7722); }
  ...
  .next-message.next-medium {
    ...
    .next-message.next-medium.next-inline {
      border-radius: 5px;
      border-radius: var(--message-size-m-border-radius, 5px); }
    .next-message.next-medium.next-toast {
      border-radius: 5px;
      border-radius: var(--message-size-m-border-radius-toast, 5px); }
  .next-message.next-large {
    ...
    .next-message.next-large.next-inline {
      border-radius: 5px;
      border-radius: var(--message-size-l-border-radius, 5px); }
    .next-message.next-large.next-toast {
      border-radius: 5px;
      border-radius: var(--message-size-l-border-radius-toast, 5px); }
...
.next-dialog {
  ...
  border-radius: 5px;
  border-radius: var(--dialog-corner, 5px);
  -webkit-box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
  -webkit-box-shadow: var(--dialog-shadow, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
          box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
          box-shadow: var(--dialog-shadow, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
  text-align: left;
  overflow: hidden;
  max-width: 90%;
  /* 让用户自己设置 */
...
.next-drawer {
  ...
  -webkit-box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
  -webkit-box-shadow: var(--drawer-shadow, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
          box-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
          box-shadow: var(--drawer-shadow, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
  overflow: auto;
  -webkit-animation-duration: 300ms;
          animation-duration: 300ms;
  -webkit-animation-timing-function: ease-in-out;
...
.next-form {
  ...
  .next-form-responsive-grid.next-large .next-form-item.next-left .next-form-item-label {
    line-height: 1.4;
    margin-top: 13px;
    margin-top: calc(var(--form-element-large-height, 40px)/2 - var(--form-element-large-font-size, 14px)/2);
    margin-bottom: 13px;
    margin-bottom: calc(var(--form-element-large-height, 40px)/2 - var(--form-element-large-font-size, 14px)/2); }
  .next-form-item {
    /* medium */
    margin-bottom: 16px;
...
.next-avatar {
  ...
  .next-avatar-square {
    border-radius: 5px;
    border-radius: var(--avatar-border-radius, 5px); }
  .next-avatar > img {
    display: block;
    width: 100%;
    height: 100%;
...
.next-select {
  ...
  .next-select-highlight {
    color: #ff7722;
    color: var(--select-highlight-color, #ff7722);
    font-size: 12px;
...
.next-menu-btn {
  ...
  .next-menu-btn.next-btn-secondary .next-menu-btn-arrow {
    color: #ff7722;
    color: var(--menu-btn-pure-text-secondary-icon-color, #ff7722); }
  ...
  .next-menu-btn.next-btn-text.next-btn-primary .next-menu-btn-arrow {
    color: #007ffc;
    color: var(--menu-btn-text-text-primary-icon-color, #007ffc); }
...
.next-nav {
  ...
  .next-nav.next-primary {
    ...
    background: #3A3C4B;
    background: var(--nav-primary-bg-color, #3A3C4B);
    border-color: #333333;
    ...
    -webkit-box-shadow: var(--nav-primary-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
            box-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
            box-shadow: var(--nav-primary-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3)); }
    ...
    .next-nav.next-primary .next-nav-item.next-menu-item {
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item.next-focused, .next-nav.next-primary .next-nav-item.next-menu-item:hover {
        background: #2A2C3C;
        background: var(--nav-primary-item-hover-bg-color, #2A2C3C);
        color: #ff7722;
        color: var(--nav-primary-item-hover-text-color, #ff7722);
        font-weight: normal;
        font-weight: var(--nav-primary-item-hover-text-style, normal); }
      .next-nav.next-primary .next-nav-item.next-menu-item.next-selected {
        background: #2A2C3C;
        background: var(--nav-primary-item-selected-bg-color, #2A2C3C);
        color: #ff7722;
        color: var(--nav-primary-item-selected-text-color, #ff7722);
        font-weight: bold;
        font-weight: var(--nav-primary-item-selected-text-style, bold); }
      .next-nav.next-primary .next-nav-item.next-menu-item.next-opened {
        background: #3A3C4B;
        background: var(--nav-primary-item-opened-bg-color, #3A3C4B);
        color: #FFFFFF;
      ...
      .next-nav.next-primary .next-nav-item.next-menu-item:before {
        background: #2A2C3C;
        background: var(--nav-primary-item-selected-active-color, #2A2C3C); }
      .next-nav.next-primary .next-nav-item.next-menu-item:hover:before {
        background: #ff7722;
        background: var(--nav-primary-item-hover-active-color, #ff7722); }
    ...
    .next-nav.next-primary .next-menu-sub-menu .next-menu-item {
      background: #3A3C4B;
      background: var(--nav-primary-sub-nav-bg-color, #3A3C4B);
      color: #FFFFFF;
      ...
      .next-nav.next-primary .next-menu-sub-menu .next-menu-item.next-focused, .next-nav.next-primary .next-menu-sub-menu .next-menu-item:hover {
        background: #3A3C4B;
        background: var(--nav-primary-sub-nav-hover-bg-color, #3A3C4B);
        color: #FFFFFF;
  ...
  .next-nav.next-secondary {
    ...
    background: #ff7722;
    background: var(--nav-secondary-bg-color, #ff7722);
    border-color: #ff7722;
    border-color: var(--nav-secondary-border-color, #ff7722);
    color: #FFFFFF;
    color: var(--nav-secondary-text-color, #FFFFFF);
    font-weight: normal;
    font-weight: var(--nav-secondary-text-style, normal);
    -webkit-box-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
    -webkit-box-shadow: var(--nav-secondary-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
            box-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
            box-shadow: var(--nav-secondary-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3)); }
    ...
    .next-nav.next-secondary .next-nav-item.next-menu-item {
      ...
      .next-nav.next-secondary .next-nav-item.next-menu-item:before {
        background: #d95711;
        background: var(--nav-secondary-item-selected-active-color, #d95711); }
      .next-nav.next-secondary .next-nav-item.next-menu-item:hover:before {
        background: #d95711;
        background: var(--nav-secondary-item-hover-active-color, #d95711); }
    ...
    .next-nav.next-secondary .next-menu-sub-menu .next-menu-item {
      background: #ff7722;
      background: var(--nav-secondary-sub-nav-bg-color, #ff7722);
      color: #FFFFFF;
  ...
  .next-nav.next-normal {
    ...
    -webkit-box-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
    -webkit-box-shadow: var(--nav-normal-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
            box-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
            box-shadow: var(--nav-normal-shadow, 2px 2px 6px 0px rgba(255, 119, 34, 0.3)); }
    .next-nav.next-normal .next-nav-item.next-menu-item {
      ...
      .next-nav.next-normal .next-nav-item.next-menu-item.next-focused, .next-nav.next-normal .next-nav-item.next-menu-item:hover {
        ...
        color: #ff7722;
        color: var(--nav-normal-item-hover-text-color, #ff7722);
        font-weight: normal;
