...
$balloon-primary-color-bg: #ff7722;
$balloon-primary-color-border: #ff7722;
...
$balloon-tooltip-color-bg: #f4f4f4;
$balloon-tooltip-shadow: none;
$balloon-tooltip-color-border: #e6e6e6;
...
$btn-pure-normal-bg-hover: #f4f4f4;
$btn-pure-normal-bg-active: #f4f4f4;
$btn-pure-normal-border-color: #d8d8d8;
$btn-pure-normal-border-color-hover: #bfbfbf;
$btn-pure-normal-border-color-active: #bfbfbf;
...
$btn-pure-secondary-color: #ff7722;
$btn-pure-secondary-color-hover: #FFFFFF;
$btn-pure-secondary-color-active: #FFFFFF;
$btn-pure-secondary-bg: #FFFFFF;
$btn-pure-secondary-bg-hover: #d95711;
$btn-pure-secondary-bg-active: #d95711;
$btn-pure-secondary-border-color: #ff7722;
$btn-pure-secondary-border-color-hover: #d95711;
$btn-pure-secondary-border-color-active: #d95711;
...
$btn-pure-primary-bg: #ff7722;
$btn-pure-primary-bg-hover: #d95711;
$btn-pure-primary-bg-active: #d95711;
...
$btn-text-primary-color: #007ffc;
$btn-text-primary-color-hover: #d95711;
$btn-text-disabled-color: #cccccc;
$btn-text-loading-color: #333333;
$btn-text-secondary-color: #666666;
$btn-text-secondary-color-hover: #ff7722;
$btn-text-normal-color: #333333;
$btn-text-normal-color-hover: #ff7722;
...
$calendar-fullscreen-table-cell-hover-background: #fff7ed;
$calendar-fullscreen-table-cell-hover-color: #ff7722;
$calendar-fullscreen-table-cell-hover-border-color: #ff7722;
$calendar-fullscreen-table-cell-select-background: #fff7ed;
$calendar-fullscreen-table-cell-select-color: #ff7722;
$calendar-fullscreen-table-cell-select-border-color: #ff7722;
$calendar-fullscreen-table-cell-select-font-weight: bold;
$calendar-fullscreen-table-cell-current-background: #FFFFFF;
$calendar-fullscreen-table-cell-current-color: #ff7722;
$calendar-fullscreen-table-cell-current-border-color: #ff7722;
...
$calendar-card-table-cell-hover-background: #fff7ed;
$calendar-card-table-cell-hover-color: #ff7722;
$calendar-card-table-cell-hover-border-color: #fff7ed;
$calendar-card-table-cell-select-background: #ff7722;
$calendar-card-table-cell-select-color: #FFFFFF;
$calendar-card-table-cell-select-border-color: #ff7722;
...
$calendar-card-table-cell-current-color: #ff7722;
$calendar-card-table-cell-current-border-color: transparent;
$calendar-card-table-cell-current-font-weight: bold;
$calendar-card-table-cell-inrange-background: #fff7ed;
$calendar-card-table-cell-inrange-color: #ff7722;
$calendar-card-table-cell-inrange-border-color: #fff7ed;
$calendar-panel-header-margin-bottom: 8px;
$calendar-panel-header-height: 32px;
$calendar-panel-header-border-bottom-width: 1px;
$calendar-panel-header-background: #ff7722;
...
$card-title-extra-color: #007ffc;
$card-title-bullet-color: #ff7722;
$card-content-color: #666666;
$card-head-bottom-border-color: #eeeeee;
$card-more-btn-color: #007ffc;
...
$collapse-title-hover-bg-color: #e6e6e6;
$collapse-title-disabled-bg-color: #f4f4f4;
...
$nav-primary-item-hover-text-color: #ff7722;
$nav-primary-item-selected-bg-color: #2A2C3C;
$nav-primary-item-selected-text-color: #ff7722;
...
$nav-primary-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
...
$nav-primary-item-hover-active-color: #ff7722;
...
$nav-primary-sub-nav-active-color: #ff7722;
$nav-primary-item-disabled-text-color: #cccccc;
$nav-primary-item-opened-text-color: #FFFFFF;
$nav-secondary-bg-color: #ff7722;
$nav-secondary-border-width: 0px;
$nav-secondary-border-color: #ff7722;
$nav-secondary-text-color: #FFFFFF;
$nav-secondary-text-style: normal;
$nav-secondary-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
$nav-secondary-sub-nav-bg-color: #ff7722;
...
$nav-secondary-item-hover-bg-color: #d95711;
$nav-secondary-item-hover-text-color: #FFFFFF;
$nav-secondary-item-hover-text-style: normal;
$nav-secondary-item-hover-active-color: #d95711;
$nav-secondary-sub-nav-hover-bg-color: #d95711;
$nav-secondary-sub-nav-hover-text-color: #FFFFFF;
$nav-secondary-item-selected-bg-color: #d95711;
...
$nav-secondary-item-selected-active-color: #d95711;
$nav-secondary-sub-nav-selected-bg-color: #d95711;
$nav-secondary-sub-nav-selected-text-color: #FFFFFF;
$nav-secondary-sub-nav-active-color: #ff7722;
$nav-secondary-item-disabled-text-color: #fff7ed;
...
$nav-normal-shadow: 2px 2px 6px 0px rgba(255, 119, 34, 0.3);
...
$nav-normal-item-hover-text-color: #ff7722;
$nav-normal-item-hover-text-style: normal;
$nav-normal-item-hover-active-color: #ff7722;
$nav-normal-sub-nav-hover-bg-color: #f4f4f4;
$nav-normal-sub-nav-hover-text-color: #ff7722;
$nav-normal-item-selected-bg-color: #f4f4f4;
$nav-normal-item-selected-text-color: #ff7722;
$nav-normal-item-selected-text-style: bold;
$nav-normal-item-childselected-bg-color: transparent;
$nav-normal-item-childselected-text-color: #ff7722;
$nav-normal-item-childselected-text-style: normal;
$nav-normal-item-selected-active-color: #ff7722;
$nav-normal-sub-nav-selected-bg-color: #f4f4f4;
$nav-normal-sub-nav-selected-text-color: #ff7722;
$nav-normal-sub-nav-active-color: #ff7722;
$nav-normal-item-disabled-text-color: #999999;
$nav-normal-item-opened-bg-color: transparent;
$nav-normal-item-opened-text-color: #ff7722;
...
$radio-hovered-bg-color: #fff7ed;
$radio-checked-bg-color: #ff7722;
$radio-disabled-bg-color: #fafafa;
$radio-checked-hovered-bg-color: #d95711;
$radio-checked-disabled-bg-color: #fafafa;
$radio-border-color: #d8d8d8;
$radio-hovered-border-color: #ff7722;
$radio-checked-border-color: #ff7722;
...
$radio-button-bg-color-hovered: #f4f4f4;
$radio-button-bg-color-checked: #FFFFFF;
$radio-button-bg-color-disabled: #fafafa;
$radio-button-bg-color-checked-disabled: #f4f4f4;
$radio-button-border-color: #d8d8d8;
$radio-button-border-color-hovered: #bfbfbf;
$radio-button-border-color-checked: #ff7722;
...
$radio-button-font-color-checked: #ff7722;
...
$rating-normal-underlay-color: #d9d9d9;
$rating-normal-overlay-color: #ff7722;
$rating-normal-overlay-hover-color: #ff7722;
$rating-grade-low-overlay-hover-color: #999999;
$rating-grade-high-overlay-color: #ff7722;
$rating-grade-high-overlay-hover-color: #ff7722;
$rating-grade-icon-content: "";

// ------------------------ search ------------------------ //

$search-normal-corner: 30px;
$search-normal-primary-color: #ff7722;
$search-normal-primary-hover-color: #ff7722;
$search-normal-primary-split-color: #eeeeee;
$search-normal-primary-shadow: none;
$search-normal-primary-btn-text-color: #FFFFFF;
$search-normal-primary-btn-hover-bg-color: #d95711;
...
$search-normal-secondary-color: #d8d8d8;
$search-normal-secondary-split-color: #eeeeee;
$search-normal-secondary-hover-color: #ff7722;
$search-normal-secondary-shadow: none;
$search-normal-secondary-btn-bg-color: #ff7722;
$search-normal-secondary-btn-text-color: #FFFFFF;
$search-normal-secondary-btn-hover-bg-color: #d95711;
...
$search-normal-dark-color: #ff7722;
$search-normal-dark-hover-color: #ff7722;
...
$search-normal-dark-btn-hover-bg-color: #d95711;
...
$search-simple-normal-color: #d8d8d8;
$search-simple-normal-hover-color: #bfbfbf;
$search-simple-normal-split-color: #d8d8d8;
...
$search-simple-dark-color: #d8d8d8;
$search-simple-dark-hover-color: #d8d8d8;
...
$search-simple-dark-split-color: #d8d8d8;
...
$pagination-item-corner: 30px;
$pagination-large-item-border-width: 1px;
$pagination-large-item-corner: 30px;
$pagination-small-item-corner: 30px;
$pagination-item-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
$pagination-item-current-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
$pagination-item-hover-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
$pagination-item-current-hover-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
$pagination-current-color: #ff7722;
...
$pagination-size-selector-filter-current-color: #ff7722;
$pagination-item-border-color: #d8d8d8;
$pagination-item-color: #333333;
$pagination-item-bg: #FFFFFF;
$pagination-item-current-border-color: #ff7722;
$pagination-item-current-color: #FFFFFF;
$pagination-item-current-bg: #ff7722;
$pagination-item-hover-border-color: #bfbfbf;
$pagination-item-hover-color: #333333;
$pagination-item-hover-bg: #f4f4f4;
...
$pagination-item-current-hover-bg: #d95711;
$pagination-arrow-hover-color: #333333;
$pagination-arrow-hover-color-noboder: #ff7722;
...
$step-arrow-item-wait-background: #e6e6e6;
$step-arrow-item-title-wait-color: #999999;
$step-arrow-item-process-background: #ff7722;
$step-arrow-item-title-process-color: #FFFFFF;
$step-arrow-item-finish-background: #fff7ed;
$step-arrow-item-title-finish-color: #ff7722;
...
$step-circle-item-tail-wait-color: #d8d8d8;
$step-circle-item-tail-process-color: #d8d8d8;
$step-circle-item-tail-finish-color: #ff7722;
...
$step-circle-item-node-wait-border-color: #bfbfbf;
$step-circle-item-node-wait-background: #FFFFFF;
$step-circle-item-node-wait-color: #666666;
$step-circle-item-node-process-border-color: #ff7722;
$step-circle-item-node-process-background: #ff7722;
$step-circle-item-node-process-color: #FFFFFF;
$step-circle-item-node-process-percent-color: #ff7722;
$step-circle-item-node-process-percent-size: 12px;
$step-circle-item-node-finish-border-color: #ff7722;
$step-circle-item-node-finish-background: #FFFFFF;
$step-circle-item-node-finish-color: #ff7722;
...
$step-dot-item-tail-wait-color: #d8d8d8;
$step-dot-item-tail-process-color: #d8d8d8;
$step-dot-item-tail-finish-color: #ff7722;
...
$step-dot-item-node-wait-border-color: #bfbfbf;
$step-dot-item-node-wait-background: #FFFFFF;
$step-dot-item-node-wait-color: #999999;
$step-dot-item-node-process-border-color: #ff7722;
$step-dot-item-node-process-background: #ff7722;
$step-dot-item-node-process-color: #ff7722;
$step-dot-item-node-finish-border-color: #ff7722;
$step-dot-item-node-finish-background: #FFFFFF;
$step-dot-item-node-finish-color: #ff7722;
...
$number-picker-inline-m-button-corner: 30px;
$number-picker-inline-l-button-corner: 30px;
...
$number-picker-inline-s-button-corner: 5px;
...
$checkbox-border-color: #d8d8d8;
$checkbox-hovered-border-color: #ff7722;
...
$checkbox-checked-bg-color: #ff7722;
$checkbox-hovered-bg-color: #fff7ed;
$checkbox-checked-hovered-bg-color: #d95711;
...
$cascader-menu-item-expanded-background-color: #f4f4f4;
...
$menu-btn-pure-text-secondary-icon-color: #ff7722;
$menu-btn-text-text-normal-icon-color: #333333;
$menu-btn-text-text-primary-icon-color: #007ffc;
...
$range-normal-unselected-color: #d8d8d8;
$range-normal-selected-color: #ff7722;
$range-normal-slider-bg-color: #FFFFFF;
$range-normal-mark-color: #999999;
$range-normal-mark-selected-color: #333333;
$range-normal-unselected-color-hover: #d8d8d8;
$range-normal-selected-color-hover: #ff7722;
...
$range-normal-unselected-color-disabled: #d8d8d8;
$range-normal-selected-color-disabled: #bfbfbf;
$range-normal-slider-bg-color-disabled: #eeeeee;
$range-normal-slider-border-color: #d8d8d8;
...
$switch-normal-on-bg-color: #ff7722;
$switch-hover-on-bg-color: #d95711;
$switch-disabled-on-bg-color: #e6e6e6;
...
$switch-disabled-on-border-color: #d8d8d8;
$switch-handle-on-border-color: transparent;
$switch-on-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.1);
$switch-normal-off-bg-color: #e6e6e6;
$switch-hover-off-bg-color: #e6e6e6;
$switch-disabled-off-bg-color: #e6e6e6;
...
$tag-fill-border-color: #e6e6e6;
$tag-fill-border-color-hover: #d9d9d9;
...
$tag-secondary-text-color: #ff7722;
$tag-normal-text-color-hover: #ff7722;
...
$tag-secondary-text-color-hover: #d95711;
$tag-bordered-border-color: #d8d8d8;
$tag-secondary-border-color: #ff7722;
$tag-checkable-normal-bg-selected: #ff7722;
$tag-checkable-secondary-bg-selected: #ff7722;
$tag-bordered-border-color-hover: #bfbfbf;
$tag-secondary-border-color-hover: #d95711;
$tag-checkable-normal-bg-selected-hover: #d95711;
$tag-checkable-secondary-bg-selected-hover: #d95711;
$tag-fill-bg-color: #e6e6e6;
$tag-primary-background-color: #ff7722;
$tag-bordered-bg: transparent;
$tag-secondary-bg: transparent;
$tag-fill-bg-color-hover: #d9d9d9;
...
$tag-checkable-fill-bg-color: #e6e6e6;
$tag-checkable-fill-border-color: #e6e6e6;
$tag-checkable-fill-text-color-hover: #333333;
$tag-checkable-fill-bg-color-hover: #d9d9d9;
$tag-checkable-fill-border-color-hover: #d9d9d9;
...
$tag-checkable-normal-border-color: #d8d8d8;
$tag-checkable-normal-bg: transparent;
$tag-checkable-normal-text-color-hover: #333333;
$tag-checkable-normal-border-color-hover: #d8d8d8;
...
$tag-checkable-primary-bg-color: #ff7722;
$tag-checkable-primary-border-color: #ff7722;
$tag-checkable-primary-text-color-disabled: #cccccc;
$tag-checkable-primary-text-color-hover: #FFFFFF;
$tag-checkable-primary-bg-color-hover: #d95711;
$tag-checkable-primary-border-color-hover: #d95711;
...
$tag-closable-primary-fill-border-color: #e6e6e6;
$tag-closable-primary-fill-bg-color: #e6e6e6;
$tag-closable-primary-fill-text-color-hover: #333333;
$tag-closable-primary-fill-border-color-hover: #d9d9d9;
$tag-closable-primary-fill-bg-color-hover: #d9d9d9;
...
$input-focus-border-color: #ff7722;
...
$input-feedback-success-color: #00d86a;
...
$upload-text-list-bg-color: #f4f4f4;
$upload-text-list-bg-color-hover: #f4f4f4;
...
$upload-text-list-name-font-color-hover: #ff7722;
$upload-text-list-size-font-color: #999999;
$upload-text-list-size-font-color-hover: #ff7722;
...
$upload-image-list-item-border-color-hover: #ff7722;
$upload-image-list-item-picture-border-color: #e6e6e6;
$upload-image-list-item-picture-background-color: #f4f4f4;
...
$upload-card-border-color: #d8d8d8;
$upload-card-hover-border-color: #ff7722;
$upload-card-font-color: #666666;
$upload-card-icon-color: #d8d8d8;
$upload-card-hover-font-color: #ff7722;
...
$upload-card-list-border-color: #d8d8d8;
...
$upload-drag-zone-border-color: #d8d8d8;
$upload-drag-zone-over-border-color: #ff7722;
...
$drawer-corner: 5px;
$drawer-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
...
$message-size-l-border-radius: 5px;
$message-size-m-border-radius: 5px;
$message-size-l-border-radius-toast: 5px;
$message-size-m-border-radius-toast: 5px;
$message-border-style: solid;
$message-border-style-toast: solid;
$message-shadow-toast: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
$message-success-color-bg-inline: #e6ffee;
$message-success-color-bg-addon: transparent;
$message-success-color-bg-toast: #FFFFFF;
$message-success-color-border-inline: #e6ffee;
...
$message-success-color-icon-inline: #00d86a;
$message-success-color-icon-addon: #00d86a;
$message-success-color-icon-toast: #00d86a;
...
$message-help-color-bg-inline: #e6f7ff;
$message-help-color-bg-addon: transparent;
$message-help-color-bg-toast: #FFFFFF;
$message-help-color-border-inline: #e6f7ff;
...
$message-help-color-icon-inline: #007ffc;
$message-help-color-icon-addon: #007ffc;
$message-help-color-icon-toast: #007ffc;
...
$message-loading-color-icon-inline: #ff7722;
$message-loading-color-icon-addon: #ff7722;
$message-loading-color-icon-toast: #ff7722;
...
$dialog-corner: 5px;
$dialog-shadow: 0px 2px 6px 0px rgba(255, 119, 34, 0.3);
...
$progress-line-underlay-color: #e6e6e6;
...
$progress-line-normal-color: #ff7722;
$progress-line-error-color: #FF3000;
$progress-line-success-color: #00d86a;
$progress-line-started-color: #FF3000;
$progress-line-middle-color: #FF9300;
$progress-line-finishing-color: #00d86a;
...
$shell-light-local-navigation-background: #d9d9d9;
...
$shell-light-content-background: #e6e6e6;
...
$shell-light-tooldock-background: #d9d9d9;
...
$shell-light-tooldock-item-background-hover: #e6e6e6;
$shell-light-tooldock-item-background-active: #e6e6e6;
$shell-dark-header-color: #FFFFFF;
$shell-dark-header-height: 52px;
$shell-dark-header-background: #000000;
$shell-dark-header-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
$shell-dark-local-navigation-background: #d9d9d9;
...
$shell-dark-content-background: #e6e6e6;
...
$shell-dark-tooldock-background: #d9d9d9;
...
$shell-dark-tooldock-item-background-hover: #e6e6e6;
$shell-dark-tooldock-item-background-active: #e6e6e6;
$shell-brand-header-color: #FFFFFF;
$shell-brand-header-height: 52px;
$shell-brand-header-background: #ff7722;
$shell-brand-header-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.1);
...
$shell-brand-local-navigation-background: #d9d9d9;
...
$shell-brand-content-background: #e6e6e6;
...
$shell-brand-tooldock-background: #d9d9d9;
...
$shell-brand-tooldock-item-background-hover: #e6e6e6;
$shell-brand-tooldock-item-background-active: #e6e6e6;
...
$transfer-simple-move-icon-color: #d8d8d8;
...
$transfer-simple-panel-footer-text-color: #ff7722;
$transfer-simple-panel-item-hover-text-color: #ff7722;
...
$time-picker-menu-border-color: #d8d8d8;
...
$time-picker-menu-item-background-hover: #f4f4f4;
$time-picker-menu-item-background-selected: #f4f4f4;
...
$slick-dots-background-color-selected: #ff7722;
...
$tab-close-icon-color-selected: #ff7722;
...
$tab-pure-text-color-selected: #ff7722;
$tab-pure-text-color-disabled: #e6e6e6;
$tab-pure-ink-bar-color: #ff7722;
...
$tab-wrapped-ink-bar-color: #ff7722;
$tab-wrapped-nav-item-border-color-active: #ff7722;
...
$tab-wrapped-bg-color-hover: #e6e6e6;
$tab-wrapped-border-line-color-hover: #d8d8d8;
$tab-wrapped-text-color-selected: #ff7722;
...
$tab-capsule-bg-color: #f4f4f4;
$tab-capsule-bg-color-hover: #e6e6e6;
$tab-capsule-bg-color-selected: #ff7722;
$tab-capsule-bg-color-disabled: #fafafa;
$tab-capsule-tab-border-line-color: #d8d8d8;
$tab-capsule-tab-border-line-color-hover: #d8d8d8;
$tab-capsule-tab-border-line-color-active: #ff7722;
...
$tab-text-text-color-selected: #ff7722;
...
$breadcrumb-text-keyword-color: #ff7722;
$breadcrumb-icon-color: #bfbfbf;
$breadcrumb-icon-sep-content: "";
$breadcrumb-text-color-hover: #ff7722;
$breadcrumb-text-current-color-hover: #ff7722;
$breadcrumb-text-keyword-color-hover: #ff7722;
