:root {
    ...
    --popup-global-shadow: var(--shadow-2-down, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
    
    
    --popup-global-corner: var(--corner-1, 5px);
    ...
    --popup-local-corner: var(--corner-1, 5px);
    ...
    --form-element-large-corner: var(--corner-3, 30px);
    
    
    --form-element-medium-corner: var(--corner-3, 30px);
    
    
    --form-element-small-corner: var(--corner-3, 30px);
    ...
    --shadow-color-sd2: var(--color-brand1-6, #ff7722);
    ...
    --balloon-normal-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --balloon-primary-color-bg: var(--color-brand1-6, #ff7722);
    
    
    --balloon-primary-color-border: var(--color-brand1-6, #ff7722);
    ...
    --balloon-corner: var(--corner-1, 5px);
    ...
    --balloon-primary-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --balloon-primary-color-close-hover: var(--color-text1-4, #333333);
    
    
    --balloon-tooltip-color-bg: var(--color-fill1-2, #f4f4f4);
    
    
    --balloon-tooltip-shadow: var(--shadow-zero, none);
    
    
    --balloon-tooltip-color-border: var(--color-line1-2, #e6e6e6);
    ...
    --btn-size-l-corner: var(--corner-3, 30px);
    
    
    --btn-size-s-corner: var(--corner-3, 30px);
    
    
    --btn-size-m-corner: var(--corner-3, 30px);
    
    
    --btn-size-l-border-width: var(--line-1, 1px);
    
    
    --btn-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --btn-shadow-hover: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --btn-pure-secondary-color: var(--color-brand1-6, #ff7722);
    ...
    --btn-pure-secondary-bg-hover: var(--color-brand1-9, #d95711);
    
    
    --btn-pure-secondary-bg-active: var(--color-brand1-9, #d95711);
    
    
    --btn-pure-secondary-border-color: var(--color-brand1-6, #ff7722);
    
    
    --btn-pure-secondary-border-color-hover: var(--color-brand1-9, #d95711);
    ...
    --btn-pure-primary-bg: var(--color-brand1-6, #ff7722);
    
    
    --btn-pure-primary-bg-hover: var(--color-brand1-9, #d95711);
    ...
    --btn-text-primary-color: var(--color-link-1, #007ffc);
    ...
    --btn-text-secondary-color-hover: var(--color-brand1-6, #ff7722);
    
    
    --btn-text-normal-color: var(--color-text1-4, #333333);
    
    
    --btn-text-normal-color-hover: var(--color-brand1-6, #ff7722);
    ...
    --calendar-card-table-cell-date-border-radius: var(--corner-circle, 50%);
    
    
    --calendar-card-table-cell-month-border-radius: var(--corner-3, 30px);
    ...
    --calendar-fullscreen-table-cell-hover-color: var(--color-brand1-6, #ff7722);
    
    
    --calendar-fullscreen-table-cell-hover-border-color: var(--color-brand1-6, #ff7722);
    
    
    --calendar-fullscreen-table-cell-select-background: var(--color-brand1-1, #fff7ed);
    
    
    --calendar-fullscreen-table-cell-select-color: var(--color-brand1-6, #ff7722);
    
    
    --calendar-fullscreen-table-cell-select-border-color: var(--color-brand1-6, #ff7722);
    ...
    --calendar-fullscreen-table-cell-current-color: var(--color-brand1-6, #ff7722);
    
    
    --calendar-fullscreen-table-cell-current-border-color: var(--color-brand1-6, #ff7722);
    ...
    --calendar-card-table-cell-year-border-radius: var(--corner-1, 5px);
    ...
    --calendar-card-table-cell-hover-color: var(--color-brand1-6, #ff7722);
    
    
    --calendar-card-table-cell-hover-border-color: var(--color-brand1-1, #fff7ed);
    
    
    --calendar-card-table-cell-select-background: var(--color-brand1-6, #ff7722);
    
    
    --calendar-card-table-cell-select-color: var(--color-white, #FFFFFF);
    
    
    --calendar-card-table-cell-select-border-color: var(--color-brand1-6, #ff7722);
    ...
    --calendar-card-table-cell-current-color: var(--color-brand1-6, #ff7722);
    ...
    --calendar-card-table-cell-inrange-color: var(--color-brand1-6, #ff7722);
    ...
    --calendar-panel-header-background: var(--color-brand1-6, #ff7722);
    ...
    --card-header-background: var(--color-transparent, transparent);
    
    
    --card-corner: var(--corner-1, 5px);
    ...
    --card-title-extra-color: var(--color-link-1, #007ffc);
    
    
    --card-title-bullet-color: var(--color-brand1-6, #ff7722);
    ...
    --card-more-btn-color: var(--color-link-1, #007ffc);
    ...
    --collapse-title-bg-color: var(--color-white, #FFFFFF);
    
    
    --collapse-border-width: var(--line-1, 1px);
    
    
    --collapse-border-corner: var(--corner-1, 5px);
    ...
    --nav-primary-bg-color: var(--color-other-1, #3A3C4B);
    
    
    --nav-primary-item-hover-bg-color: var(--color-other-2, #2A2C3C);
    
    
    --nav-primary-item-hover-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-primary-item-selected-bg-color: var(--color-other-2, #2A2C3C);
    
    
    --nav-primary-item-selected-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-hoz-item-selected-active-line: var(--line-2, 2px);
    
    
    --nav-primary-item-selected-active-color: var(--color-other-2, #2A2C3C);
    
    
    --nav-primary-sub-nav-bg-color: var(--color-other-1, #3A3C4B);
    
    
    --nav-primary-sub-nav-hover-bg-color: var(--color-other-1, #3A3C4B);
    
    
    --nav-primary-item-opened-bg-color: var(--color-other-1, #3A3C4B);
    ...
    --nav-primary-shadow: var(--shadow-2, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
    ...
    --nav-primary-item-hover-active-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-primary-sub-nav-active-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-secondary-bg-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-secondary-border-width: var(--line-zero, 0px);
    
    
    --nav-secondary-border-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-secondary-shadow: var(--shadow-2, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
    
    
    --nav-secondary-sub-nav-bg-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-secondary-item-hover-active-color: var(--color-brand1-9, #d95711);
    ...
    --nav-secondary-item-selected-active-color: var(--color-brand1-9, #d95711);
    ...
    --nav-secondary-sub-nav-active-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-normal-shadow: var(--shadow-2, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
    ...
    --nav-normal-item-hover-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-item-hover-text-style: var(--font-weight-2, normal);
    
    
    --nav-normal-item-hover-active-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-sub-nav-hover-bg-color: var(--color-fill1-2, #f4f4f4);
    
    
    --nav-normal-sub-nav-hover-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-item-selected-bg-color: var(--color-fill1-2, #f4f4f4);
    
    
    --nav-normal-item-selected-text-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-normal-item-childselected-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-item-childselected-text-style: var(--font-weight-2, normal);
    
    
    --nav-normal-item-selected-active-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-sub-nav-selected-bg-color: var(--color-fill1-2, #f4f4f4);
    
    
    --nav-normal-sub-nav-selected-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-normal-sub-nav-active-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-normal-item-opened-text-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-line-item-hover-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-item-hover-text-style: var(--font-weight-2, normal);
    
    
    --nav-line-item-hover-active-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-sub-nav-hover-bg-color: var(--color-transparent, transparent);
    
    
    --nav-line-sub-nav-hover-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-item-selected-bg-color: var(--color-transparent, transparent);
    
    
    --nav-line-item-selected-text-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-line-item-childselected-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-item-childselected-text-style: var(--font-weight-2, normal);
    
    
    --nav-line-item-selected-active-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-sub-nav-selected-bg-color: var(--color-transparent, transparent);
    
    
    --nav-line-sub-nav-selected-text-color: var(--color-brand1-6, #ff7722);
    
    
    --nav-line-sub-nav-active-color: var(--color-brand1-6, #ff7722);
    ...
    --nav-line-item-opened-text-color: var(--color-brand1-6, #ff7722);
    ...
    --radio-button-corner-large: var(--corner-3, 30px);
    ...
    --radio-checked-bg-color: var(--color-brand1-6, #ff7722);
    ...
    --radio-hovered-border-color: var(--color-brand1-6, #ff7722);
    
    
    --radio-checked-border-color: var(--color-brand1-6, #ff7722);
    ...
    --radio-button-corner-medium: var(--corner-1, 5px);
    
    
    --radio-button-corner-small: var(--corner-1, 5px);
    ...
    --radio-button-border-color-checked: var(--color-brand1-6, #ff7722);
    ...
    --radio-button-font-color-checked: var(--color-brand1-6, #ff7722);
    ...
    --rating-grade-low-overlay-color: var(--color-text1-2, #999999);
    ...
    --rating-normal-overlay-color: var(--color-brand1-6, #ff7722);
    
    
    --rating-normal-overlay-hover-color: var(--color-brand1-6, #ff7722);
    
    
    --rating-grade-low-overlay-hover-color: var(--color-text1-2, #999999);
    
    
    --rating-grade-high-overlay-color: var(--color-brand1-6, #ff7722);
    
    
    --rating-grade-high-overlay-hover-color: var(--color-brand1-6, #ff7722);
    ...
    --search-normal-corner: var(--corner-3, 30px);
    
    
    --search-normal-primary-color: var(--color-brand1-6, #ff7722);
    
    
    --search-normal-primary-hover-color: var(--color-brand1-6, #ff7722);
    ...
    --search-normal-secondary-hover-color: var(--color-brand1-6, #ff7722);
    
    
    --search-normal-secondary-shadow: var(--shadow-zero, none);
    
    
    --search-normal-secondary-btn-bg-color: var(--color-brand1-6, #ff7722);
    ...
    --search-normal-dark-color: var(--color-brand1-6, #ff7722);
    
    
    --search-normal-dark-hover-color: var(--color-brand1-6, #ff7722);
    ...
    --search-simple-corner: var(--corner-1, 5px);
    ...
    --pagination-item-corner: var(--corner-3, 30px);
    
    
    --pagination-large-item-border-width: var(--line-1, 1px);
    
    
    --pagination-large-item-corner: var(--corner-3, 30px);
    
    
    --pagination-small-item-corner: var(--corner-3, 30px);
    
    
    --pagination-item-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --pagination-item-current-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --pagination-item-hover-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --pagination-item-current-hover-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --pagination-current-color: var(--color-brand1-6, #ff7722);
    ...
    --pagination-size-selector-filter-current-color: var(--color-brand1-6, #ff7722);
    ...
    --pagination-item-current-border-color: var(--color-brand1-6, #ff7722);
    
    
    --pagination-item-current-color: var(--color-white, #FFFFFF);
    
    
    --pagination-item-current-bg: var(--color-brand1-6, #ff7722);
    ...
    --pagination-arrow-hover-color-noboder: var(--color-brand1-6, #ff7722);
    ...
    --step-arrow-item-process-background: var(--color-brand1-6, #ff7722);
    ...
    --step-arrow-item-title-finish-color: var(--color-brand1-6, #ff7722);
    ...
    --step-circle-item-tail-finish-color: var(--color-brand1-6, #ff7722);
    ...
    --step-circle-item-node-process-border-color: var(--color-brand1-6, #ff7722);
    
    
    --step-circle-item-node-process-background: var(--color-brand1-6, #ff7722);
    
    
    --step-circle-item-node-process-color: var(--color-white, #FFFFFF);
    
    
    --step-circle-item-node-process-percent-color: var(--color-brand1-6, #ff7722);
    
    
    --step-circle-item-node-process-percent-size: var(--font-size-body-1, 12px);
    
    
    --step-circle-item-node-finish-border-color: var(--color-brand1-6, #ff7722);
    
    
    --step-circle-item-node-finish-background: var(--color-white, #FFFFFF);
    
    
    --step-circle-item-node-finish-color: var(--color-brand1-6, #ff7722);
    ...
    --step-dot-item-tail-finish-color: var(--color-brand1-6, #ff7722);
    ...
    --step-dot-item-node-process-border-color: var(--color-brand1-6, #ff7722);
    
    
    --step-dot-item-node-process-background: var(--color-brand1-6, #ff7722);
    
    
    --step-dot-item-node-process-color: var(--color-brand1-6, #ff7722);
    
    
    --step-dot-item-node-finish-border-color: var(--color-brand1-6, #ff7722);
    
    
    --step-dot-item-node-finish-background: var(--color-white, #FFFFFF);
    
    
    --step-dot-item-node-finish-color: var(--color-brand1-6, #ff7722);
    ...
    --number-picker-inline-m-button-corner: var(--corner-3, 30px);
    
    
    --number-picker-inline-l-button-corner: var(--corner-3, 30px);
    ...
    --number-picker-inline-s-button-corner: var(--corner-1, 5px);
    ...
    --checkbox-border-radius: var(--corner-1, 5px);
    ...
    --checkbox-hovered-border-color: var(--color-brand1-6, #ff7722);
    ...
    --checkbox-checked-bg-color: var(--color-brand1-6, #ff7722);
    ...
    --timeline-item-process-background: var(--color-brand1-6, #ff7722);
    ...
    --timeline-item-success-background: var(--color-success-3, #00d86a);
    ...
    --cascader-menu-border-radius: var(--corner-1, 5px);
    ...
    --menu-btn-pure-text-secondary-icon-color: var(--color-brand1-6, #ff7722);
    
    
    --menu-btn-text-text-normal-icon-color: var(--color-text1-4, #333333);
    
    
    --menu-btn-text-text-primary-icon-color: var(--color-link-1, #007ffc);
    ...
    --range-size-m-slider-shadow-moving: var(--shadow-2, 2px 2px 6px 0px rgba(255, 119, 34, 0.3));
    
    
    --range-normal-unselected-color: var(--color-line1-3, #d8d8d8);
    
    
    --range-normal-selected-color: var(--color-brand1-6, #ff7722);
    ...
    --range-normal-selected-color-hover: var(--color-brand1-6, #ff7722);
    
    
    --range-normal-slider-bg-color-hover: var(--color-white, #FFFFFF);
    
    
    --range-size-m-slider-shadow: var(--shadow-1, 1px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --range-size-m-slider-shadow-hover: var(--shadow-3, 4px 4px 10px 0px rgba(0, 0, 0, 0.1));
    ...
    --tree-node-title-border-radius: var(--corner-1, 5px);
    ...
    --tree-switch-corner: var(--corner-1, 5px);
    ...
    --tree-node-selected-background: var(--color-brand1-1, #fff7ed);
    ...
    --switch-size-m-radius-container: var(--corner-3, 30px);
    
    
    --switch-size-m-trigger: var(--s-6, 24px);
    
    
    --switch-size-m-radius-trigger: var(--corner-3, 30px);
    ...
    --switch-size-s-radius-container: var(--corner-3, 30px);
    
    
    --switch-size-s-trigger: var(--s-5, 20px);
    
    
    --switch-size-s-radius-trigger: var(--corner-3, 30px);
    ...
    --switch-normal-on-bg-color: var(--color-brand1-6, #ff7722);
    ...
    --switch-on-shadow: var(--shadow-1, 1px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --switch-off-shadow: var(--shadow-1, 1px 1px 2px 0px rgba(0, 0, 0, 0.1));
    
    
    --switch-rtl-on-shadow: var(--shadow-1-left, -1px 0px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --typography-text-code-corner: var(--corner-1, 5px);
    ...
    --tag-corner-radius: var(--corner-1, 5px);
    
    
    --tag-checkable-corner-radius: var(--corner-1, 5px);
    ...
    --tag-secondary-text-color: var(--color-brand1-6, #ff7722);
    
    
    --tag-normal-text-color-hover: var(--color-brand1-6, #ff7722);
    ...
    --tag-secondary-border-color: var(--color-brand1-6, #ff7722);
    
    
    --tag-checkable-normal-bg-selected: var(--color-brand1-6, #ff7722);
    
    
    --tag-checkable-secondary-bg-selected: var(--color-brand1-6, #ff7722);
    ...
    --tag-primary-background-color: var(--color-brand1-6, #ff7722);
    ...
    --tag-checkable-primary-bg-color: var(--color-brand1-6, #ff7722);
    
    
    --tag-checkable-primary-border-color: var(--color-brand1-6, #ff7722);
    ...
    --input-border-color: var(--color-line1-3, #d8d8d8);
    ...
    --input-focus-border-color: var(--color-brand1-6, #ff7722);
    ...
    --input-multiple-corner: var(--corner-1, 5px);
    ...
    --input-feedback-success-color: var(--color-success-3, #00d86a);
    ...
    --loading-dot-color: var(--color-brand1-6, #ff7722);
    ...
    --table-sort-color-current: var(--color-brand1-6, #ff7722);
    ...
    --upload-text-list-name-font-color-hover: var(--color-brand1-6, #ff7722);
    
    
    --upload-text-list-size-font-color: var(--color-text1-2, #999999);
    
    
    --upload-text-list-size-font-color-hover: var(--color-brand1-6, #ff7722);
    ...
    --upload-image-list-item-border-color-hover: var(--color-brand1-6, #ff7722);
    ...
    --upload-card-hover-border-color: var(--color-brand1-6, #ff7722);
    ...
    --upload-card-hover-font-color: var(--color-brand1-6, #ff7722);
    ...
    --upload-drag-zone-over-border-color: var(--color-brand1-6, #ff7722);
    
    
    --upload-drag-zone-corner: var(--corner-1, 5px);
    ...
    --badge-size-custom-border-radius: var(--corner-1, 5px);
    ...
    --select-highlight-color: var(--color-brand1-6, #ff7722);
    ...
    --drawer-corner: var(--corner-1, 5px);
    
    
    --drawer-shadow: var(--shadow-2-down, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
    ...
    --message-size-l-border-radius: var(--corner-1, 5px);
    
    
    --message-size-m-border-radius: var(--corner-1, 5px);
    
    
    --message-size-l-border-radius-toast: var(--corner-1, 5px);
    
    
    --message-size-m-border-radius-toast: var(--corner-1, 5px);
    ...
    --message-shadow-toast: var(--shadow-2-down, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
    
    
    --message-success-color-bg-inline: var(--color-success-1, #e6ffee);
    ...
    --message-success-color-border-inline: var(--color-success-1, #e6ffee);
    ...
    --message-success-color-icon-inline: var(--color-success-3, #00d86a);
    
    
    --message-success-color-icon-addon: var(--color-success-3, #00d86a);
    
    
    --message-success-color-icon-toast: var(--color-success-3, #00d86a);
    ...
    --message-help-color-bg-inline: var(--color-help-1, #e6f7ff);
    ...
    --message-help-color-border-inline: var(--color-help-1, #e6f7ff);
    ...
    --message-help-color-icon-inline: var(--color-help-3, #007ffc);
    
    
    --message-help-color-icon-addon: var(--color-help-3, #007ffc);
    
    
    --message-help-color-icon-toast: var(--color-help-3, #007ffc);
    ...
    --message-loading-color-icon-inline: var(--color-brand1-6, #ff7722);
    
    
    --message-loading-color-icon-addon: var(--color-brand1-6, #ff7722);
    
    
    --message-loading-color-icon-toast: var(--color-brand1-6, #ff7722);
    ...
    --dialog-corner: var(--corner-1, 5px);
    
    
    --dialog-shadow: var(--shadow-2-down, 0px 2px 6px 0px rgba(255, 119, 34, 0.3));
    ...
    --progress-line-radius-l: var(--corner-3, 30px);
    
    
    --progress-line-radius-m: var(--corner-3, 30px);
    
    
    --progress-line-radius-s: var(--corner-3, 30px);
    
    
    --progress-line-font-color: var(--color-text1-4, #333333);
    
    
    --progress-line-normal-color: var(--color-brand1-6, #ff7722);
    
    
    --progress-line-error-color: var(--color-error-3, #FF3000);
    
    
    --progress-line-success-color: var(--color-success-3, #00d86a);
    ...
    --progress-line-finishing-color: var(--color-success-3, #00d86a);
    ...
    --progress-circle-normal-color: var(--color-brand1-6, #ff7722);
    
    
    --progress-circle-error-color: var(--color-error-3, #FF3000);
    
    
    --progress-circle-success-color: var(--color-success-3, #00d86a);
    ...
    --progress-circle-finishing-color: var(--color-success-3, #00d86a);
    ...
    --shell-dark-header-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --shell-brand-header-background: var(--color-brand1-6, #ff7722);
    
    
    --shell-brand-header-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --transfer-panel-border-corner: var(--corner-1, 5px);
    ...
    --transfer-simple-panel-footer-text-color: var(--color-brand1-6, #ff7722);
    
    
    --transfer-simple-panel-item-hover-text-color: var(--color-brand1-6, #ff7722);
    ...
    --slick-dots-background-color-selected: var(--color-brand1-6, #ff7722);
    ...
    --menu-shadow: var(--shadow-1-down, 0px 1px 2px 0px rgba(0, 0, 0, 0.1));
    ...
    --menu-icon-selected-color: var(--color-brand1-6, #ff7722);
    ...
    --menu-icon-selected-hover-color: var(--color-brand1-6, #ff7722);
    ...
    --avatar-border-radius: var(--corner-1, 5px);
    ...
    --tab-close-icon-color-selected: var(--color-brand1-6, #ff7722);
    ...
    --tab-pure-text-color-selected: var(--color-brand1-6, #ff7722);
    
    
    --tab-pure-text-color-disabled: var(--color-line1-2, #e6e6e6);
    
    
    --tab-pure-ink-bar-color: var(--color-brand1-6, #ff7722);
    ...
    --tab-wrapped-tab-corner-radius: var(--corner-1, 5px);
    ...
    --tab-wrapped-ink-bar-color: var(--color-brand1-6, #ff7722);
    
    
    --tab-wrapped-nav-item-border-color-active: var(--color-brand1-6, #ff7722);
    ...
    --tab-wrapped-text-color-selected: var(--color-brand1-6, #ff7722);
    ...
    --tab-capsule-bg-color-selected: var(--color-brand1-6, #ff7722);
    ...
    --tab-capsule-tab-border-line-color-active: var(--color-brand1-6, #ff7722);
    
    
    --tab-capsule-tab-border-line-color-disabled: var(--color-line1-1, #eeeeee);
    
    
    --tab-capsule-corner-radius: var(--corner-1, 5px);
    ...
    --tab-text-text-color-selected: var(--color-brand1-6, #ff7722);
    ...
    --breadcrumb-text-keyword-color: var(--color-brand1-6, #ff7722);
    ...
    --breadcrumb-text-color-hover: var(--color-brand1-6, #ff7722);
    
    
    --breadcrumb-text-current-color-hover: var(--color-brand1-6, #ff7722);
    
    
    --breadcrumb-text-keyword-color-hover: var(--color-brand1-6, #ff7722);
