...
var rax_find_dom_node_1 = tslib_1.__importDefault(require("rax-find-dom-node"));
...
var isIOS10 = utils_1.isIOS && /^10./.test(utils_1.osVersion);
...
var PickerColumn = function (props, ref) {
  ...
  var _b = props.prefix,
      ...
      others = tslib_1.__rest(props, ["prefix", "value", "data", "onChange", "onScrollChange"]);

  var forceUpdate = hooks_1.useForceUpdate();
  var scrollHandlers = rax_1.useRef(null);
  var scrollRef = rax_1.createRef();
  var contentRef = rax_1.createRef();
  var itemRef = rax_1.createRef();
  var maskRef = rax_1.createRef();
  var itemHeight;
  var scrollValue;
  ...
  rax_1.useEffect(function () {
    setTimeout(function () {
      var itemNode = rax_find_dom_node_1.default(itemRef.current);
      var maskNode = rax_find_dom_node_1.default(maskRef.current);
      var scrollNode = rax_find_dom_node_1.default(scrollRef.current);
      var contentNode = rax_find_dom_node_1.default(contentRef.current);
      ...
      if (!scrollHandlers.current) {
        ...
        var willPreventDefault_1 = passiveSupported ? {
          passive: false
        } : false;
        var willNotPreventDefault_1 = passiveSupported ? {
          passive: true
        } : false;
        Object.keys(scrollHandlers.current).forEach(function (key) {
          if (key.indexOf('touch') === 0 || key.indexOf('mouse') === 0) {
            var pd = key.indexOf('move') >= 0 ? willPreventDefault_1 : willNotPreventDefault_1;
  ...
  return rax_1.createElement(view_1.default, tslib_1.__assign({}, others, {
    ...
    className: classnames_1.default(clsPrefix + "-col", (_a = {}, _a[clsPrefix + "-col--ios10"] = isIOS10, _a)),
    ref: scrollRef
  }, rax_1.createElement(view_1.default, {
    ...
    return rax_1.createElement(view_1.default, {
      key: index,
      className: classnames_1.default(clsPrefix + "-col-item", (_a = {}, _a[clsPrefix + "-col-item--disabled"] = item.disabled, _a[clsPrefix + "-col-item--selected"] = !item.disabled && item.value === value, _a)),
...
exports.default = rax_1.forwardRef(PickerColumn);