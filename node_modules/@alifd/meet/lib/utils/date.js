...
exports.getRealRange = exports.getNearestDate = exports.getRangeDate = exports.checkDateRange = exports.RANGE_CHECK_RESULT = exports.isTypeSame = exports.getDateNum = exports.cloneDate = exports.toDay = exports.isBetween = exports.toDate = exports.toValidDate = exports.isValidDate = exports.formatDate = void 0;
...
function formatDate(d, format, invalidStr) {
  ...
  if (!fp_1.isInvalidValue(d)) {
    var date = dayjs_1.default(d);
...
function isBetween(date, startDate, endDate, unit, intervalMode) {
  ...
  return dayjs_1.default(date).isBetween(startDate, endDate, unit, intervalMode);
}

exports.isBetween = isBetween;

function toDay(from) {
  return dayjs_1.default(from);
}
...
})(RANGE_CHECK_RESULT = exports.RANGE_CHECK_RESULT || (exports.RANGE_CHECK_RESULT = {}));
...
function checkDateRange(d, options, validRange) {
  ...
  if (options.time && isCheckDate !== TIME_PRE_CHECK.SKIP) {
    var _b = options.time,
        hasHour = _b.hasHour,
        hasMinute = _b.hasMinute,
        hasSecond = _b.hasSecond;
...
function getNearestDate(options, extra, d, calcType) {
  var _a = options.hasHour,
      hasHour = _a === void 0 ? false : _a,
      _b = options.hasMinute,
      hasMinute = _b === void 0 ? false : _b,
      _c = options.hasSecond,
      hasSecond = _c === void 0 ? false : _c;
  var _d = extra.hourStep,
      hourStep = _d === void 0 ? 1 : _d,
      _e = extra.minuteStep,
      minuteStep = _e === void 0 ? 1 : _e,
      _f = extra.secondStep,
      secondStep = _f === void 0 ? 1 : _f;
