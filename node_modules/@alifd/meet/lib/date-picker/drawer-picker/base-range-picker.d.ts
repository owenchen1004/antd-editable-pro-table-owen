...
declare abstract class BaseRangePicker extends Component<BaseDateRangePickerProps, RangePickerState> {
    ...
    abstract renderFirstChild(value: Date, validRange: DateRange, onChange: any): RaxNode;
    abstract renderSecondChild(value: Date, validRange: DateRange, onChange: any): RaxNode;
    render(): JSX.Element;
}
