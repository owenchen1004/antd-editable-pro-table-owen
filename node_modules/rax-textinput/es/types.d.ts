...
export interface TextInputProps extends Rax.RefAttributes<{
    _nativeNode: TextInputElement;
    focus: () => void;
    blur: () => void;
    clear: () => void;
}>, Omit<Rax.InputHTMLAttributes<HTMLInputElement> & Rax.TextareaHTMLAttributes<HTMLTextAreaElement>, 'onBlur' | 'onChange' | 'onInput' | 'onFocus'> {
    /**
