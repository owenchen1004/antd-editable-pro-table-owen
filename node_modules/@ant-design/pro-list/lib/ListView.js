...
function ListView(props) {
  ...
  // 兼容 5.2.0 以下的版本
  if ((0, _proUtils.compareVersions)(_antd.version, '5.2.0') < 0) usePaginationArgs.reverse();
  // 合并分页的的配置
  ...
  // 兼容 5.2.0 以下的版本
  if ((0, _proUtils.compareVersions)(_antd.version, '5.2.0') < 0) useSelectionArgs.reverse();
