...
import { createElement, useRef, forwardRef } from 'rax';
...
var View = forwardRef(function (props, ref) {
  ...
  return createElement("div", _extends({}, rest, {
    ...
    ref: ref,
    className: cx(isWeexV2 ? 'rax-view-v2' : '', className),
    style: Object.assign({}, _getStyle(cx(isWeexV2 ? 'rax-view-v2' : '', className)), style)
  }));
});
