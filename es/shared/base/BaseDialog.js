...
export var BaseDialog = /*#__PURE__*/function (_Component) {
  ...
  _proto.transformProps = function transformProps() {
    ...
    if (((_this$props3 = this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.operations.length) === 0) {
      ...
      innerProps.footer = /*#__PURE__*/React.createElement(_Space, null, (_this$props4 = this.props) === null || _this$props4 === void 0 ? void 0 : (_this$props4$operatio = _this$props4.operations) === null || _this$props4$operatio === void 0 ? void 0 : _this$props4$operatio.map(function (item) {
        var _item$content;
